...
var V = (e, t) => {
	...
	style: { color: "var(--st-text-tertiary)" }
}, te = ["onUpdate:modelValue"], q = ["value"], ne = ["onClick", "title"], J = {
	class: "w-3 h-3",
	viewBox: "0 0 16 16",
	fill: "currentColor"
}, re = {
	...
	class: "text-xs w-12 shrink-0",
	style: { color: "var(--st-text-tertiary)" }
}, ce = ["onUpdate:modelValue"], le = ["value"], ue = ["onClick", "title"], Y = {
	class: "w-3 h-3",
	viewBox: "0 0 16 16",
	fill: "currentColor"
}, de = {
	...
	setup(t, { emit: n }) {
		...
		return (n, r) => (y(), o("div", {
			...
			(y(!0), o(e, null, S(O.value, (n, i) => (y(), o("div", {
				...
				}, [(y(), o("svg", J, [n.desc ? (y(), o("path", ie)) : (y(), o("path", re))])), l(" " + C(n.desc ? "DESC" : "ASC"), 1)], 12, ne),
				s("button", {
			...
			p.value ? (y(), o(e, { key: 2 }, [
				...
				(y(!0), o(e, null, S(A.value, (n, i) => (y(), o("div", {
					...
					s("button", {
						...
						onClick: (e) => b(j("sub", i)),
						title: n.desc ? "Descending — click to toggle" : "Ascending — click to toggle"
					}, [(y(), o("svg", Y, [n.desc ? (y(), o("path", fe)) : (y(), o("path", de))])), l(" " + C(n.desc ? "DESC" : "ASC"), 1)], 12, ue),
					s("button", {
						class: "shrink-0 w-5 h-5 flex items-center justify-center rounded transition-colors",
						style: { color: "var(--st-text-tertiary)" },
						title: "Remove sort rule",
	...
	UPDATE: "update",
	DELETE: "delete"
}, _e = "__pending_", ve = { class: "relative flex items-center" }, ye = {
	key: 0,
	class: "w-3.5 h-3.5",
	viewBox: "0 0 16 16",
	fill: "currentColor"
	...
	setup(e, { emit: n }) {
		...
		return (e, n) => (y(), o("div", ve, [s("button", {
			ref_key: "triggerRef",
			ref: h,
	...
	setup(n, { emit: c }) {
		...
		function re(e) {
			v.value === "columns" ? ie(e) : v.value === "operators" ? ae(e) : e.key !== "Escape" && K(), e.key === "Escape" && (se(), D.value?.blur());
		}
		function ie(e) {
			let t = z.value;
			if (t.length !== 0) {
		...
		function ae(e) {
			let t = L.value;
			t.length !== 0 && (e.key === "ArrowDown" ? (e.preventDefault(), E.value = Math.min(E.value + 1, t.length - 1), oe("operator-picker")) : e.key === "ArrowUp" ? (e.preventDefault(), E.value = Math.max(E.value - 1, 0), oe("operator-picker")) : (e.key === "Enter" || e.key === "Tab") && (e.preventDefault(), t[E.value] && q(t[E.value].value)));
		}
		function oe(e) {
			m(() => {
		...
		return k(w, () => {
			...
			s("div", {
				...
				}, [s("span", Pe, C(e.id), 1), T(f) ? (y(), o("span", Q, C(e.type), 1)) : a("", !0)], 44, Ne))), 128)), R.value.length === 0 ? (y(), o("div", Fe, " No columns found ")) : a("", !0)], 4)) : a("", !0)])),
				...
				}, [(y(!0), o(e, null, S(I.value, (t, n) => (y(), o(e, { key: n }, [t.type === "header" ? (y(), o("div", Ie, C(t.label), 1)) : (y(), o("div", {
					key: 1,
					class: "flex items-center justify-between px-3 py-1.5 cursor-pointer text-[13px]",
...
function pt(e) {
	return typeof e != "object" || !e ? !1 : e.danger === !0 || e.variant === "destructive" ? !0 : /^delete/i.test(String(e.key ?? ""));
}
//#endregion
...
var mt = {
...
}, _t = ["onClick"], vt = ["innerHTML"], yt = ["onClick"], bt = /* @__PURE__ */ V({
	...
	setup(t, { emit: n }) {
		...
		function E(e) {
			p("selection-action", e.key, _()), m.value = !1;
		}
		function D(e) {
			p("selection-action", e.key, _()), m.value = !1;
		}
		return (n, r) => (y(), o("div", mt, [
			...
			s("div", {
				...
				s("button", {
					class: "w-full text-left px-3 py-1.5 hover-menu-item",
					style: { color: "var(--st-text)" },
					onClick: r[7] ||= (e) => b("json")
				}, "Download as JSON"),
				t.contextMenuActions.length > 0 ? (y(), o(e, { key: 0 }, [r[13] ||= s("div", {
					class: "my-1",
					style: { borderTop: "1px solid var(--st-border-secondary)" }
				}, null, -1), (y(!0), o(e, null, S(t.contextMenuActions, (e) => (y(), o("button", {
					key: e.key,
					type: "button",
					class: "w-full text-left px-3 py-1.5 hover-menu-item flex items-center gap-2",
					style: g({ color: T(pt)(e) ? "var(--st-danger)" : "var(--st-text)" }),
					onClick: (t) => E(e)
				}, [e.icon ? (y(), o("span", {
					key: 0,
					class: "shrink-0 w-3.5 h-3.5 inline-flex items-center justify-center [&_svg]:max-w-full [&_svg]:max-h-full",
					innerHTML: e.icon
				}, null, 8, vt)) : a("", !0), s("span", null, C(e.label), 1)], 12, _t))), 128))], 64)) : a("", !0),
...
}, [["__scopeId", "data-v-edc94983"]]), xt = { class: "flex items-center gap-1.5 px-2 py-1.5 cursor-default overflow-hidden" }, St = {
	...
	setup(e) {
		...
		return (n, d) => (y(), o("th", {
			...
			s("div", xt, [
				s("span", St, [e.header.isPlaceholder ? a("", !0) : (y(), i(T(N), {
					key: 0,
					render: e.header.column.columnDef.header,
					props: e.header.getContext()
				}, null, 8, ["render", "props"]))]),
				T(r) ? (y(), o("span", Ct, C(T(b).type), 1)) : a("", !0),
				e.header.column.getIsSorted() ? (y(), o("span", wt, C(e.header.column.getIsSorted() === "asc" ? "↑" : "↓"), 1)) : a("", !0),
				T(b).isFrozen ? (y(), o("span", Tt, "❄")) : a("", !0),
				s("button", {
					ref_key: "triggerRef",
					ref: v,
...
}, [["__scopeId", "data-v-032be2da"]]), Dt = ["title"], Ot = {
	class: "text-xs",
	style: { color: "var(--st-text-secondary)" }
}, kt = {
	key: 1,
...
}, Ht = ["title"], Ut = ["title"], Wt = ["innerHTML"], Gt = ["title", "onClick"], Kt = ["innerHTML"], qt = {
	key: 1,
	class: "text-[11px]"
}, Jt = {
	__name: "TableCell",
	...
	setup(t, { emit: n }) {
		...
		let J = r(() => {
		...
		}), re = r(() => U.value && !H.value.badge), ie = r(() => {
			let e = H.value;
			...
			let i = String(r).trim();
			return i === "" ? null : i;
		}), oe = r(() => c.cell.getValue() == null), se = r(() => ae.value ? oe.value ? !0 : !J.value : !1), ce = r(() => se.value ? "flex items-start gap-1 min-w-0" : "flex items-center gap-1 min-w-0");
		function le() {
			L.value || I("select");
		}
		function ue() {
			!u.value?.update || re.value || H.value.progressBar || H.value.segmentedBar || q.value.length > 0 || (L.value = !0, I("editing-change", !0), R.value = c.cell.getValue() ?? "", m(() => {
				z.value && (z.value.focus(), z.value.select(), Y());
			}));
		}
		function Y() {
		...
		function pe(e) {
			e.key === "Enter" && !e.shiftKey ? (e.preventDefault(), de()) : e.key === "Escape" && fe();
		}
		function me() {
		...
		return (n, r) => (y(), o("div", {
			...
			onClick: le,
			onDblclick: ue
		}, [re.value ? (y(), o(e, { key: 0 }, [T(u).update ? (y(), o("button", {
			key: 0,
		...
		}, [s("span", { class: h(["absolute top-0.5 w-3 h-3 rounded-full bg-white transition-transform", t.cell.getValue() ? "left-3.5" : "left-0.5"]) }, null, 2)], 4), s("span", Ot, C(t.cell.getValue() ? "true" : "false"), 1)])) : (y(), o("span", kt, [t.cell.getValue() === null || t.cell.getValue() === void 0 ? (y(), o("span", At, "NULL")) : (y(), o(e, { key: 1 }, [l(C(t.cell.getValue() ? "true" : "false"), 1)], 64))]))], 64)) : L.value ? (y(), o(e, { key: 1 }, [ee(s("textarea", {
			ref_key: "textareaRef",
			ref: z,
		...
		])], 64)) : G.value ? (y(), o(e, { key: 2 }, [G.value.total === 0 ? (y(), o("div", Mt, [...r[2] ||= [s("span", {
			class: "italic text-[13px]",
			style: { color: "var(--st-text-placeholder)" }
		}, "—", -1)]])) : (y(), o("div", Nt, [s("div", Pt, [(y(!0), o(e, null, S(G.value.segments, (e) => (y(), o("div", {
			key: e.label,
			class: "h-full shrink-0",
			style: g({
				width: K(e.count, G.value.total),
				backgroundColor: e.color
			})
		}, null, 4))), 128))]), s("div", Ft, [(y(!0), o(e, null, S(G.value.segments, (e) => (y(), o("span", {
			key: e.label,
			class: "text-[11px] leading-snug tabular-nums whitespace-nowrap",
			style: { color: "var(--st-text-secondary)" }
		}, C(e.count) + " " + C(e.label), 1))), 128))])]))], 64)) : W.value === null ? (y(), o("div", {
			key: 4,
			class: h(ce.value),
			style: g(P.value ? {
			...
			s("div", zt, [t.cell.getValue() === null || t.cell.getValue() === void 0 ? (y(), o("span", Bt, "NULL")) : J.value ? (y(), o("span", {
				key: 1,
				class: "inline-flex shrink-0 self-start items-center px-1.5 py-0.5 rounded text-[11px] font-medium leading-tight",
				style: g(J.value.style)
			}, C(J.value.text), 5)) : te.value === "wrap" ? (y(), o("span", Vt, C(t.cell.getValue()), 1)) : (y(), o("span", {
				key: 3,
				class: "truncate block",
				title: String(t.cell.getValue())
			}, C(t.cell.getValue()), 9, Ht)), se.value ? (y(), o("span", {
				key: 4,
				class: h(["block text-[11px] leading-snug", te.value === "wrap" ? "whitespace-pre-wrap break-words" : "truncate"]),
				style: { color: "var(--st-text-secondary)" },
				title: te.value === "wrap" ? void 0 : ae.value
			}, C(ae.value), 11, Ut)) : a("", !0)]),
			ie.value ? (y(), o("span", {
				key: 0,
				class: "w-3.5 h-3.5 shrink-0 flex items-center justify-center",
				style: g({ color: ie.value.color || "var(--st-text-secondary)" }),
				innerHTML: ie.value.svg
			}, null, 12, Wt)) : a("", !0),
			q.value.length > 0 ? (y(), o("div", {
				key: 1,
				class: h(["flex items-center gap-0.5 shrink-0", F.value])
			}, [(y(!0), o(e, null, S(q.value, (e) => (y(), o("button", {
				key: e.label,
				...
				innerHTML: e.icon
			}, null, 8, Kt)) : (y(), o("span", qt, C(e.label), 1))], 8, Gt))), 128))], 2)) : a("", !0)
		], 6)) : (y(), o("div", It, [s("div", Lt, [s("div", {
			class: "h-full rounded-full transition-all duration-300",
			style: g({
				width: `${W.value}%`,
				backgroundColor: "var(--st-accent)"
			})
		}, null, 4)]), s("span", Rt, C(Math.round(W.value)) + "% ", 1)]))], 44, Dt));
	}
}, Yt = ["data-index"], Xt = {
	class: "group/row",
	style: {
...
}, Zt = { class: "flex h-full gap-1 pr-1.5 pl-1 items-center justify-end pl-0.5" }, Qt = { class: "flex min-w-0 flex-1 items-center justify-end gap-0.5" }, $t = {
	class: "text-xs text-right whitespace-nowrap",
	style: { color: "var(--st-text-tertiary)" }
}, en = ["checked"], tn = /* @__PURE__ */ V({
	...
	setup(t) {
		...
		return (n, r) => (y(), o("div", {
			...
			s("div", {
			...
			}, [s("div", Zt, [s("div", Qt, [R() ? (y(), o("button", {
				key: 0,
				...
				stroke: "currentColor",
				"stroke-width": "2"
			}, [s("path", { d: "M6 2h8v8M14 2L6 10" })], -1)]])) : a("", !0), s("span", $t, C(t.orderNumber), 1)])])], 4),
			s("div", {
			...
			(y(!0), o(e, null, S(t.row.getVisibleCells(), (e) => (y(), i(Jt, {
				key: e.id,
				cell: e,
				...
				onContextmenu: M((r) => n.$emit("context-menu", r, t.row, e), ["prevent"])
			}, null, 8, [
				"cell",
				"is-selected",
				"onSelect",
...
}, [["__scopeId", "data-v-9f93e669"]]), nn = 36, rn = 56, an = 40, on = 300, sn = {
	...
	setup(t, { emit: n }) {
		let a = t, s = n, c = d("cellOverflow", "truncate"), l = d("getSubTable", null), u = d("expanded"), f = typeof window < "u" && "onscrollend" in window, p = r(() => T(u) ?? {}), m = B(r(() => {
			...
			return {
				...
				estimateSize: (i) => {
					...
					if (!a) return nn;
					let o = n ? rn : nn;
					return r[a.id] ? t[a.id] ? Math.max(o, on) : Math.max(o, an) : o;
				},
				overscan: 8,
		...
		return (n, r) => (y(), o("div", { style: g({
			...
			height: _.value + "px",
			width: t.totalTableWidth + "px"
		}) }, [(y(!0), o(e, null, S(h.value, (e) => (y(), i(tn, {
			key: e.key,
			ref_for: !0,
			ref: (t) => v(t, e),
			row: t.rows[e.index],
	...
	setup(t, { emit: n }) {
		...
		}, [(y(!0), o(e, null, S(t.rows, (e, n) => (y(), i(tn, {
			key: e.id,
			row: e,
			"row-index": n,
...
}, ln = ["checked", "indeterminate"], un = {
	key: 0,
	class: "absolute inset-0 flex items-center justify-center pointer-events-none",
	style: { top: "33px" }
}, dn = { class: "flex flex-col items-center gap-4 text-center px-6 pointer-events-auto" }, fn = {
	...
	style: { color: "var(--st-accent)" }
}, mn = { class: "flex flex-col gap-1" }, hn = {
	...
	setup(n, { expose: c, emit: u }) {
		...
		}), I = r(() => !v.value.insert || !(N != null && String(T(N)).trim()) ? !1 : F.value.length === 0), L = d("insertRow", () => {}), R = x(!1), z = d("nestingDepth", 0), B = u, V = x(null), H = x(null), U = d("tableSourceRows", null), W = r(() => (U != null && w(U), m.table.getHeaderGroups())), G = r(() => 84 + m.table.getVisibleLeafColumns().reduce((e, t) => e + t.getSize(), 0)), K = r(() => (U != null && w(U), m.table.getRowModel().rows)), te = r(() => (U != null && w(U), m.table.getVisibleLeafColumns())), q = r(() => m.table.getState().pagination), ne = d("isRowDisplayedSelected", null);
		function J(e) {
			let t = T(ne);
			return typeof t == "function" ? t(e) : e.getIsSelected();
		}
		let re = r(() => K.value.length ? K.value.every((e) => J(e)) : !1), ie = r(() => {
			if (!K.value.length) return !1;
			let e = K.value.some((e) => J(e)), t = K.value.every((e) => J(e));
			return e && !t;
		});
		function ae(e, t) {
			V.value = `${e}:${t}`;
		...
		function ce() {
			m.table.toggleAllPageRowsSelected(!re.value);
		}
		let le = x(null);
		function ue(e, t, n) {
			if (t?.shiftKey && le.value !== null) {
				let e = Math.min(le.value, n), t = Math.max(le.value, n), r = K.value;
				for (let n = e; n <= t; n++) r[n].toggleSelected(!0);
			} else e.toggleSelected(!J(e));
			le.value = n;
		}
		let Y = r(() => {
			let e = D ? "inset -1px 0 0 var(--st-border)" : "", t = "2px 0 4px var(--st-shadow-sticky)";
			return e ? `${e}, ${t}` : t;
		}), de = r(() => K.value.length > bn), fe = E("scroller");
		function pe(e, t) {
			H.value = e ? t : null;
		}
		function me() {
		...
		return c({
			...
			style: g({ width: G.value + "px" })
		}, [s("thead", null, [(y(!0), o(e, null, S(W.value, (t) => (y(), o("tr", { key: t.id }, [
			s("th", {
			...
			(y(!0), o(e, null, S(t.headers, (e) => (y(), i(Et, {
				key: e.id,
				header: e,
				table: n.table
			}, null, 8, ["header", "table"]))), 128))
		]))), 128))])], 4)], 4), K.value.length > 0 && de.value ? (y(), i(sn, {
			key: 0,
			rows: K.value,
			"scroll-element-ref": fe.value,
			"total-table-width": G.value,
			"selected-cell": V.value,
			"editing-row-id": H.value,
			"pagination-state": q.value,
			...
			class: "border-separate border-spacing-0 table-fixed w-full border-0 bg-transparent",
			style: g({ width: G.value + "px" })
		}, [s("tbody", null, [(y(), o(e, null, S(xn, (t) => s("tr", { key: t }, [
			s("td", {
			...
			(y(!0), o(e, null, S(te.value, (e, n) => (y(), o("td", {
				key: e.id,
		...
		])), 64))])], 4)], 4)) : a("", !0)], 2), K.value.length === 0 && !k.value ? (y(), o("div", un, [s("div", dn, [
			s("div", fn, [(y(), o("svg", pn, [...c[13] ||= [s("rect", {
				x: "3",
				y: "3",
				width: "18",
				height: "18",
			...
			s("div", mn, [s("p", hn, C(T(A)), 1), s("p", gn, C(T(j)), 1)]),
			v.value.insert ? (y(), o("div", _n, [
				I.value ? (y(), o("button", {
					key: 0,
					class: "flex items-center gap-1.5 px-3 py-1 rounded text-[13px] font-medium transition-colors",
					style: {
					...
					onClick: c[4] ||= (e) => T(L)()
				}, C(T(N)), 1)) : T(N) ? (y(), o("div", vn, [s("button", {
...
}, wn = ["disabled"], Tn = { class: "flex items-center gap-1.5" }, En = ["value", "max"], Dn = {
	key: 1,
	class: "tabular-nums",
	style: { color: "var(--st-text)" }
}, On = ["disabled"], kn = { class: "flex items-center gap-1.5" }, An = ["value"], jn = {
	...
	stroke: "currentColor",
	"stroke-width": "2"
}, Fn = { style: { color: "var(--st-text-tertiary)" } }, In = {
	class: "text-[13px] mb-4",
	style: { color: "var(--st-text-secondary)" }
}, Ln = { class: "flex items-center justify-end gap-2" }, Rn = {
	...
	setup(n, { emit: c }) {
		...
		return (r, c) => (y(), o("div", Cn, [
			s("button", {
				...
				viewBox: "0 0 16 16",
				fill: "currentColor"
			}, [s("path", { d: "M9.78 12.78a.75.75 0 01-1.06 0L4.47 8.53a.75.75 0 010-1.06l4.25-4.25a.75.75 0 011.06 1.06L6.06 8l3.72 3.72a.75.75 0 010 1.06z" })], -1)]], 8, wn),
			s("div", Tn, [
				...
				n.hasRandomAccess ? (y(), o("input", {
					...
					onChange: k
				}, null, 40, En)) : (y(), o("span", Dn, C(h.value + 1), 1)),
			...
			s("button", {
				...
				viewBox: "0 0 16 16",
				fill: "currentColor"
			}, [s("path", { d: "M6.22 3.22a.75.75 0 011.06 0l4.25 4.25a.75.75 0 010 1.06l-4.25 4.25a.75.75 0 01-1.06-1.06L9.94 8 6.22 4.28a.75.75 0 010-1.06z" })], -1)]], 8, On),
			c[14] ||= s("div", {
				class: "w-px h-4 mx-1",
				style: { backgroundColor: "var(--st-border)" }
			}, null, -1),
			s("div", kn, [c[10] ||= s("span", null, "Rows per page:", -1), s("select", {
				value: _.value,
			...
			n.stagedEdits && n.pendingEditCount > 0 ? (y(), o(e, { key: 0 }, [
				s("span", jn, C(n.pendingEditCount) + " pending change" + C(n.pendingEditCount === 1 ? "" : "s"), 1),
				s("button", {
				...
				}, [n.committing ? (y(), o("svg", Pn, [...c[11] ||= [s("path", {
					d: "M8 1.5a6.5 6.5 0 1 1-6.5 6.5",
					"stroke-linecap": "round"
				}, null, -1)]])) : a("", !0), l(" " + C(n.committing ? "Committing…" : "Commit"), 1)], 8, Nn),
				c[12] ||= s("div", {
					class: "w-px h-4 mx-1",
					style: { backgroundColor: "var(--st-border)" }
				}, null, -1)
			], 64)) : a("", !0),
			s("span", Fn, C(D.value.toLocaleString()) + " " + C(D.value === 1 ? n.countLabelSingular : n.countLabelPlural), 1),
			(y(), i(t, { to: "body" }, [A.value ? (y(), o("div", {
				...
				s("p", In, " This will discard " + C(n.pendingEditCount) + " pending change" + C(n.pendingEditCount === 1 ? "" : "s") + ". This action cannot be undone. ", 1),
				s("div", Ln, [s("button", {
...
}, Bn = { class: "flex items-center gap-2" }, Vn = {
	class: "text-sm",
	style: { color: "var(--st-text)" }
}, Hn = {
...
}, Un = { class: "flex-1 overflow-auto px-5 py-4" }, Wn = {
	key: 0,
	class: "mb-6"
}, Gn = { class: "flex items-start gap-4" }, Kn = { class: "w-40 shrink-0 pt-2" }, qn = {
	class: "text-[13px] font-medium",
	style: { color: "var(--st-text)" }
}, Jn = {
	class: "text-xs",
	style: { color: "var(--st-text-tertiary)" }
}, Yn = { class: "flex-1" }, Xn = ["disabled", "onClick"], Zn = {
	class: "text-xs",
	style: { color: "var(--st-text-secondary)" }
}, Qn = ["value"], $n = ["onUpdate:modelValue", "placeholder"], er = { key: 1 }, tr = { class: "flex items-start gap-4" }, nr = { class: "w-40 shrink-0 pt-2" }, rr = {
	class: "text-[13px] font-medium",
	style: { color: "var(--st-text)" }
}, ir = {
	class: "text-xs",
	style: { color: "var(--st-text-tertiary)" }
}, ar = { class: "flex-1" }, or = ["disabled", "onClick"], sr = {
	class: "text-xs",
	style: { color: "var(--st-text-secondary)" }
}, cr = ["value"], lr = ["onUpdate:modelValue", "placeholder"], ur = {
	...
	setup(t, { emit: n }) {
		...
		return _(() => {
			...
			s("div", zn, [s("div", Bn, [s("span", Vn, C(t.mode === "insert" ? "Insert row into" : "Update row from"), 1), s("code", Hn, C(t.tableName), 1)]), s("button", {
			...
			s("div", Un, [m.value.length > 0 ? (y(), o("div", Wn, [(y(!0), o(e, null, S(m.value, (n) => (y(), o("div", {
				key: n.id,
				class: "mb-4"
			}, [s("div", Gn, [s("div", Kn, [s("div", qn, C(n.id), 1), s("div", Jn, C(n.meta.type), 1)]), s("div", Yn, [n.meta.type === "boolean" ? (y(), o("button", {
				key: 0,
			...
			}, [s("span", { class: h(["absolute top-[2px] w-[14px] h-[14px] rounded-full bg-white transition-transform", w.value[n.id] ? "left-[17px]" : "left-[2px]"]) }, null, 2)], 4), s("span", Zn, C(w.value[n.id] ? "true" : "false"), 1)], 10, Xn)) : (y(), o(e, { key: 1 }, [n.meta.isPrimaryKey && t.mode === "update" || n.meta.readOnly && t.mode === "insert" ? (y(), o("input", {
				key: 0,
				value: w.value[n.id],
			...
			}, null, 8, $n)), [[O, w.value[n.id]]])], 64))])])]))), 128))])) : a("", !0), b.value.length > 0 ? (y(), o("div", er, [r[3] ||= s("div", { class: "mb-3" }, [s("h3", {
				...
				key: n.id,
				class: "mb-4"
			}, [s("div", tr, [s("div", nr, [s("div", rr, C(n.id), 1), s("div", ir, C(n.meta.type), 1)]), s("div", ar, [n.meta.type === "boolean" ? (y(), o("button", {
				key: 0,
				class: h(["flex items-center gap-2", { "opacity-50 cursor-not-allowed": n.meta.readOnly && t.mode === "insert" }]),
				disabled: n.meta.readOnly && t.mode === "insert",
				onClick: (e) => !(n.meta.readOnly && t.mode === "insert") && (w.value[n.id] = !w.value[n.id])
				...
				class: "inline-block w-8 h-[18px] rounded-full relative transition-colors",
				style: g({ backgroundColor: w.value[n.id] ? "var(--st-accent)" : "var(--st-toggle-off)" })
			}, [s("span", { class: h(["absolute top-[2px] w-[14px] h-[14px] rounded-full bg-white transition-transform", w.value[n.id] ? "left-[17px]" : "left-[2px]"]) }, null, 2)], 4), s("span", sr, C(w.value[n.id] ? "true" : "false"), 1)], 10, or)) : (y(), o(e, { key: 1 }, [n.meta.readOnly && t.mode === "insert" ? (y(), o("input", {
				key: 0,
				value: w.value[n.id],
				class: "w-full rounded px-3 py-2 text-[13px] outline-none cursor-not-allowed",
				style: {
			...
			}, null, 8, lr)), [[O, w.value[n.id]]])], 64))])])]))), 128))])) : a("", !0)]),
			s("div", ur, [s("button", {
	...
	setup(n, { emit: c }) {
		let u = d("editable", !0), f = d("themeVars", {}), p = d("getRowPendingState", () => null), m = d("getCellPendingState", () => null), h = n, b = c, w = r(() => h.row ? p(h.row.id) : null), E = r(() => h.row && h.cell ? m(h.row.id, h.cell.column.id) : null), D = r(() => w.value === "insert" ? "Discard new row" : w.value === "delete" ? "Restore row" : w.value === "update" ? "Undo row changes" : null), O = x(null), k = r(() => h.cell ? h.cell.getValue() : null), A = r(() => h.cell ? h.cell.column.id : null);
		function j(e) {
		...
		function M() {
			h.row && j(JSON.stringify(h.row.original, null, 2)), b("close");
		}
		function N() {
		...
		function R(e) {
			b("row-action", e.key, h.row?.original), b("close");
		}
		z(O, () => {
			b("close");
		});
		...
		let V = r(() => {
			...
			return h.y > t / 2 ? n.bottom = `${t - h.y}px` : n.top = `${h.y}px`, h.x > e / 2 ? n.right = `${e - h.x}px` : n.left = `${h.x}px`, n;
		});
		return (r, c) => (y(), i(t, { to: "body" }, [s("div", {
			...
			s("button", {
				...
				style: { color: "var(--st-text)" },
				onClick: N
			}, [(y(), o("svg", hr, [...c[4] ||= [s("path", { d: "M.75 3a.75.75 0 000 1.5h14.5a.75.75 0 000-1.5H.75zM3 7.75A.75.75 0 013.75 7h8.5a.75.75 0 010 1.5h-8.5A.75.75 0 013 7.75zm3 4a.75.75 0 01.75-.75h2.5a.75.75 0 010 1.5h-2.5a.75.75 0 01-.75-.75z" }, null, -1)]])), c[5] ||= l(" Filter by value ", -1)]),
			...
			n.customActions.length > 0 ? (y(), o(e, { key: 1 }, [c[9] ||= s("div", {
				class: "my-1",
				style: { borderTop: "1px solid var(--st-border-secondary)" }
			}, null, -1), (y(!0), o(e, null, S(n.customActions, (e) => (y(), o("button", {
				key: e.key,
				type: "button",
				class: "w-full text-left px-3 py-1.5 flex items-center gap-2 hover-menu-item",
				style: g({ color: T(pt)(e) ? "var(--st-danger)" : "var(--st-text)" }),
				...
				class: "shrink-0 w-3.5 h-3.5 inline-flex items-center justify-center [&_svg]:max-w-full [&_svg]:max-h-full",
				innerHTML: e.icon
			}, null, 8, _r)) : a("", !0), s("span", null, C(e.label), 1)], 12, gr))), 128))], 64)) : a("", !0),
			T(u).update || T(u).delete ? (y(), o(e, { key: 2 }, [
				...
				T(u).update ? (y(), o("button", {
					...
					style: { color: "var(--st-text)" },
					onClick: P
				}, [(y(), o("svg", vr, [...c[10] ||= [s("path", { d: "M11.013 1.427a1.75 1.75 0 012.474 0l1.086 1.086a1.75 1.75 0 010 2.474l-8.61 8.61c-.21.21-.47.364-.756.445l-3.251.93a.75.75 0 01-.927-.928l.929-3.25a1.75 1.75 0 01.445-.758l8.61-8.61z" }, null, -1)]])), c[11] ||= l(" Edit row ", -1)])) : a("", !0),
				T(u).delete && w.value !== "delete" ? (y(), o("button", {
					key: 1,
					class: "w-full text-left px-3 py-1.5 flex items-center gap-2 hover-menu-item",
					style: { color: "#ef4444" },
					onClick: F
...
}, [["__scopeId", "data-v-cc9f9e30"]]), br = { class: "px-5 pt-5 pb-4" }, xr = { style: { color: "var(--st-text-secondary)" } }, Sr = {
	class: "px-5 py-3 flex items-center justify-end gap-2",
	style: { borderTop: "1px solid var(--st-border-secondary)" }
}, Cr = {
	...
	setup(e, { emit: n }) {
		...
		return (n, c) => (y(), i(t, { to: "body" }, [e.modelValue ? (y(), o("div", {
			...
			style: { color: "var(--st-text)" }
		}, "Confirm deletion", -1), s("p", xr, " Are you sure you want to delete " + C(e.rowCount) + " row" + C(e.rowCount > 1 ? "s" : "") + "? This action cannot be undone. ", 1)]), s("div", Sr, [s("button", {
			type: "button",
			class: "px-3 py-1.5 rounded text-[13px] transition-colors",
			style: {
				border: "1px solid var(--st-border-secondary)",
...
function Tr(e, t) {
	let n = e.length, r = {};
	if (n === 0) return r;
	let i = Math.max(wr * n, Math.floor(t)), a = Math.floor(i / n), o = i - a * n;
...
var Dr = ["data-st-theme"], Or = {
...
}, kr = { class: "flex-1" }, Ar = { class: "flex flex-1 min-h-0 min-w-0" }, jr = { class: "flex flex-col flex-1 min-w-0 min-h-0" }, Mr = "-apple-system, BlinkMacSystemFont, \"Segoe UI\", Roboto, \"Helvetica Neue\", Arial, sans-serif", Nr = /* @__PURE__ */ V({
	__name: "DataTable",
	props: {
		columns: {
			type: Array,
	...
	setup(t, { expose: c, emit: l }) {
		...
		b(f, O);
		let A = r(() => ({ "--dt-font-family": O.value || Mr })), ee = r(() => ({
			...E.value,
			...A.value,
			backgroundColor: "var(--st-bg)",
			color: "var(--st-text)"
		...
		let re = x([]), ie = x([]), ae = x({}), oe = x({}), se = r(() => p.expandedRows ?? oe.value);
		function ce(e) {
			p.expandedRows === null ? oe.value = {
				...oe.value,
				[e]: !oe.value[e]
		...
		let ue = r(() => {
			...
			return "id";
		}), Y = r(() => p.totalCount !== null), de = r(() => p.totalFilteredCount == null ? p.totalCount : p.totalFilteredCount), fe = r(() => new Set((p.additionalSelectedRowIds || []).map((e) => String(e)))), pe = r(() => {
		...
		function he(e) {
			let t = ue.value, n = String(e.original[t] ?? e.original.id);
			return e.getIsSelected() || fe.value.has(n);
		}
		b("isRowDisplayedSelected", he);
		let X = x(/* @__PURE__ */ new Map()), ge = x(!1), ve = 0;
		function ye() {
			return ve += 1, `${_e}${Date.now()}_${ve}`;
		}
		function be(e) {
			let t = ue.value;
			return p.rows.find((n) => String(n[t] ?? n.id) === String(e));
		}
		let xe = r(() => X.value.size > 0), Se = r(() => X.value.size), Ce = r(() => {
			if (!p.stagedEdits || X.value.size === 0) return p.rows;
			let e = ue.value, t = [], n = p.rows.map((t) => {
		...
		function Ne() {
			if (ge.value || !xe.value) return;
			let e = Me();
			ge.value = !0, V("commit-edits", e, (e) => {
				ge.value = !1, e && (X.value = /* @__PURE__ */ new Map());
			});
		}
		function Pe() {
			X.value = /* @__PURE__ */ new Map(), V("discard-edits");
		}
		let Q = R({
			data: Ce,
			get columns() {
			...
			onPaginationChange: (e) => {
				...
				te.value = t, Y.value && V("page-change", {
			...
			onColumnSizingInfoChange: (e) => {
				let t = ne.value, n = typeof e == "function" ? e(t) : e;
				ne.value = n, t.isResizingColumn && !n.isResizingColumn && V("column-resize", q.value);
			},
			...
			get pageCount() {
				if (Y.value) return Math.ceil(p.totalCount / te.value.pageSize);
			},
			enableRowSelection: !0,
			enableMultiRowSelection: !0,
			enableColumnResizing: !0,
			columnResizeMode: "onChange",
			getRowId: (e) => e.__stagedId ? String(e.__stagedId) : String(e[ue.value] ?? e.id)
		}), Fe = r(() => {
		...
		let Le = pe, Re = r(() => pe.value > 0), ze = x({
			open: !1,
			mode: "insert",
			rowData: null
		});
		...
		function We(e) {
			if (ze.value.mode === "insert") p.stagedEdits ? we(e) : V("insert-row", e);
			else if (p.stagedEdits) {
				let t = ue.value, n = String(e[t] ?? e.id), r = be(n) ?? {}, i = {};
				for (let n of Object.keys(e)) n !== t && e[n] !== r[n] && (i[n] = e[n]);
				Object.keys(i).length > 0 && Te(n, i);
			} else V("update-row", {
				id: e.id,
				changes: e
			});
		...
		function Ge(e) {
			p.stagedEdits ? Ee(e) : V("delete-rows", e), Q.resetRowSelection(), V("update:additionalSelectedRowIds", []);
		}
		function Ke(e) {
		...
		function Ye(e, t, n) {
			p.stagedEdits ? Te(e, { [t]: n }) : V("update-row", {
				id: e,
				changes: { [t]: n }
			});
		}
		...
		b("themeVars", r(() => ({
			...E.value,
			...A.value
		}))), b("originalColumnMetaById", Fe), b("table", Q), b("tableSourceRows", Ce), b("tableName", p.tableName), b("showDataTypes", p.showDataTypes), b("editable", H), b("showRowBorders", p.showRowBorders), b("showColumnBorders", p.showColumnBorders), b("cellButtonVisibility", r(() => p.cellButtonVisibility)), b("cellOverflow", r(() => p.cellOverflow)), b("insertRow", () => V("insert-row")), b("openInsertPanel", Be), b("emptyTitle", r(() => p.emptyTitle)), b("emptyMessage", r(() => p.emptyMessage)), b("defaultInsertLabel", r(() => p.defaultInsertLabel)), b("insertActions", r(() => p.insertActions)), b("loading", r(() => p.loading)), b("expanded", se), b("toggleRowExpanded", ce), b("getSubTable", p.getSubTable), b("nestingDepth", p.nestingDepth), b("parentTheme", r(() => p.theme)), b("parentAccentColor", r(() => p.accentColor)), b("subTableSorting", re), b("subTableColumnFilters", ie), b("subTableColumnVisibility", ae), b("stagedEditsEnabled", r(() => p.stagedEdits)), b("getRowPendingState", ke), b("getCellPendingState", Ae), b("getCellPreviousValue", je), b("undoRowEdit", De), b("undoCellEdit", Oe), k(() => p.rows, () => {
			Q.resetRowSelection();
		});
		function $e() {
			let e = {};
			...
			t.font = `13px ${n}`;
			let r = Q.getAllLeafColumns(), i = Ce.value.slice(0, 200);
			for (let n of r) {
		...
		return _(() => {
			...
			nt();
		}), c({ openDeleteConfirmation: Ke }), (r, c) => (y(), o("div", {
			ref_key: "rootElRef",
			ref: M,
			...
			t.showToolbar ? (y(), o(e, { key: 0 }, [Re.value ? (y(), i(bt, {
				key: 0,
				"selected-count": T(Le),
				table: T(Q),
				editable: H.value,
				...
				"total-filtered-count": Y.value ? de.value : null,
				...
				onDeleteConfirmRequest: qe,
				onSelectionAction: c[0] ||= (e, t) => V("selection-action", e, t, me()),
				onSelectAllMatching: c[1] ||= (e) => V("select-all-matching"),
				onClearFullSelection: Ie
			}, null, 8, [
				"selected-count",
				"table",
				"editable",
				...
				"sub-table-sorting": re.value,
				"sub-table-column-filters": ie.value,
				"sub-table-column-visibility": ae.value,
				"table-name": t.tableName,
				"onUpdate:sorting": c[2] ||= (e) => W.value = e,
				"onUpdate:columnFilters": c[3] ||= (e) => G.value = e,
				"onUpdate:columnVisibility": c[4] ||= (e) => J.value = e,
				"onUpdate:subTableSorting": c[5] ||= (e) => re.value = e,
				"onUpdate:subTableColumnFilters": c[6] ||= (e) => ie.value = e,
				"onUpdate:subTableColumnVisibility": c[7] ||= (e) => ae.value = e,
				onInsertRow: Ve,
			...
			s("div", Ar, [s("div", jr, [u(Sn, {
				...
				onContextMenu: Xe,
				onEditRow: He
			}, null, 8, ["table"]), t.showPagination ? (y(), i(Rn, {
				key: 0,
				table: T(Q),
				"total-count": t.totalCount,
				"has-random-access": t.hasRandomAccess,
				"staged-edits": t.stagedEdits,
				"pending-edit-count": Se.value,
				committing: ge.value || t.loading,
				"count-label-singular": t.countLabelSingular,
				"count-label-plural": t.countLabelPlural,
				onCommit: Ne,
				onDiscard: Pe
				...
				default: j(() => [(H.value.insert || H.value.update) && ze.value.open ? (y(), i(dr, {
					key: 0,
					mode: ze.value.mode,
					"row-data": ze.value.rowData,
					table: T(Q),
					"table-name": t.tableName,
					onSave: We,
					onClose: Ue
			...
			$.value.show ? (y(), i(yr, {
				...
				onClose: Ze,
				onEditRow: c[13] ||= (e) => He($.value.row.original),
				onDeleteRow: c[14] ||= (e) => Ke([$.value.row.id]),
				onFilterByValue: Qe,
				onUndoRow: c[15] ||= (e) => De($.value.row.id),
				onUndoCell: c[16] ||= (e) => Oe($.value.row.id, e),
...
}, [["__scopeId", "data-v-8bc91bb1"]]);
//#endregion
export { Nr as DataTable };
