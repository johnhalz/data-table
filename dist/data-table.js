...
var mt = {
...
}, [["__scopeId", "data-v-10f6e0bb"]]), St = { class: "flex items-center gap-1.5 px-2 py-1.5 cursor-default overflow-hidden" }, Ct = {
	...
	setup(e) {
		...
		return (n, d) => (y(), o("th", {
			...
			s("div", St, [
				s("span", Ct, [e.header.isPlaceholder ? a("", !0) : (y(), i(T(P), {
					key: 0,
					render: e.header.column.columnDef.header,
					props: e.header.getContext()
				}, null, 8, ["render", "props"]))]),
				T(r) ? (y(), o("span", wt, C(T(b).type), 1)) : a("", !0),
				e.header.column.getIsSorted() ? (y(), o("span", Tt, C(e.header.column.getIsSorted() === "asc" ? "↑" : "↓"), 1)) : a("", !0),
				T(b).isFrozen ? (y(), o("span", Et, "❄")) : a("", !0),
				s("button", {
					ref_key: "triggerRef",
					ref: v,
...
}, [["__scopeId", "data-v-032be2da"]]), Ot = ["title"], kt = {
	class: "text-xs",
	style: { color: "var(--st-text-secondary)" }
}, At = {
	key: 1,
...
}, Ut = ["title"], Wt = ["title"], Gt = ["innerHTML"], Kt = ["title", "onClick"], qt = ["innerHTML"], Jt = {
	key: 1,
	class: "text-[11px]"
}, Yt = {
	__name: "TableCell",
	...
	setup(t, { emit: n }) {
		...
		return (n, r) => (y(), o("div", {
		...
		}, [s("span", { class: h(["absolute top-0.5 w-3 h-3 rounded-full bg-white transition-transform", t.cell.getValue() ? "left-3.5" : "left-0.5"]) }, null, 2)], 4), s("span", kt, C(t.cell.getValue() ? "true" : "false"), 1)])) : (y(), o("span", At, [t.cell.getValue() === null || t.cell.getValue() === void 0 ? (y(), o("span", jt, "NULL")) : (y(), o(e, { key: 1 }, [l(C(t.cell.getValue() ? "true" : "false"), 1)], 64))]))], 64)) : R.value ? (y(), o(e, { key: 1 }, [M(s("textarea", {
			ref_key: "textareaRef",
			ref: B,
		...
		])], 64)) : K.value ? (y(), o(e, { key: 2 }, [K.value.total === 0 ? (y(), o("div", Nt, [...r[2] ||= [s("span", {
			class: "italic text-[13px]",
			style: { color: "var(--st-text-placeholder)" }
		}, "—", -1)]])) : (y(), o("div", Pt, [s("div", Ft, [(y(!0), o(e, null, S(K.value.segments, (e) => (y(), o("div", {
			key: e.label,
		...
		}, null, 4))), 128))]), s("div", It, [(y(!0), o(e, null, S(K.value.segments, (e) => (y(), o("span", {
			key: e.label,
			...
			s("div", Bt, [t.cell.getValue() === null || t.cell.getValue() === void 0 ? (y(), o("span", Vt, "NULL")) : Y.value ? (y(), o("span", {
				key: 1,
			...
			}, C(Y.value.text), 5)) : ee.value === "wrap" ? (y(), o("span", Ht, C(t.cell.getValue()), 1)) : (y(), o("span", {
				key: 3,
				class: "truncate block",
				title: String(t.cell.getValue())
			}, C(t.cell.getValue()), 9, Ut)), oe.value ? (y(), o("span", {
				key: 4,
			...
			J.value.length > 0 ? (y(), o("div", {
				...
				innerHTML: e.icon
			}, null, 8, qt)) : (y(), o("span", Jt, C(e.label), 1))], 8, Kt))), 128))], 2)) : a("", !0)
		], 6)) : (y(), o("div", Lt, [s("div", Rt, [s("div", {
			class: "h-full rounded-full transition-all duration-300",
			style: g({
				width: `${G.value}%`,
				backgroundColor: "var(--st-accent)"
			})
		}, null, 4)]), s("span", zt, C(Math.round(G.value)) + "% ", 1)]))], 44, Ot));
	}
}, Xt = ["data-index"], Zt = {
	class: "group/row",
	style: {
...
}, Qt = { class: "flex h-full gap-1 pr-1.5 pl-1 items-center justify-end pl-0.5" }, $t = { class: "flex min-w-0 flex-1 items-center justify-end gap-0.5" }, en = {
	class: "text-xs text-right whitespace-nowrap",
	style: { color: "var(--st-text-tertiary)" }
}, tn = ["checked"], nn = /* @__PURE__ */ H({
	...
	setup(t) {
		...
		return (n, r) => (y(), o("div", {
			...
			s("div", {
				...
				stroke: "currentColor",
				"stroke-width": "2"
			}, [s("path", { d: "M6 2h8v8M14 2L6 10" })], -1)]])) : a("", !0), s("span", en, C(t.orderNumber), 1)])])], 4),
			s("div", {
			...
			(y(!0), o(e, null, S(t.row.getVisibleCells(), (e) => (y(), i(Yt, {
				key: e.id,
				cell: e,
...
}, [["__scopeId", "data-v-9f93e669"]]), rn = 36, an = 56, on = 40, sn = 300, cn = {
	...
	setup(t, { emit: n }) {
		let a = t, s = n, c = d("cellOverflow", "truncate"), l = d("getSubTable", null), u = d("expanded"), f = typeof window < "u" && "onscrollend" in window, p = r(() => T(u) ?? {}), m = V(r(() => {
			...
			return {
				...
				estimateSize: (i) => {
					...
					if (!a) return rn;
					let o = n ? an : rn;
					return r[a.id] ? t[a.id] ? Math.max(o, sn) : Math.max(o, on) : o;
				},
				overscan: 8,
		...
		return (n, r) => (y(), o("div", { style: g({
			...
			height: _.value + "px",
			width: t.totalTableWidth + "px"
		}) }, [(y(!0), o(e, null, S(h.value, (e) => (y(), i(nn, {
			key: e.key,
			ref_for: !0,
			ref: (t) => v(t, e),
			row: t.rows[e.index],
	...
	setup(t, { emit: n }) {
		...
		}, [(y(!0), o(e, null, S(t.rows, (e, n) => (y(), i(nn, {
			key: e.id,
			row: e,
			"row-index": n,
...
}, un = ["checked", "indeterminate"], dn = {
	key: 0,
	class: "absolute inset-0 flex items-center justify-center pointer-events-none",
	style: { top: "33px" }
}, fn = { class: "flex flex-col items-center gap-4 text-center px-6 pointer-events-auto" }, pn = {
	...
	style: { color: "var(--st-accent)" }
}, hn = { class: "flex flex-col gap-1" }, gn = {
	...
	setup(n, { expose: c, emit: u }) {
		...
		let X = r(() => {
			...
			return e ? `${e}, ${t}` : t;
		}), ue = r(() => q.value.length > xn), de = E("scroller");
		function fe(e, t) {
			U.value = e ? t : null;
		}
		function pe() {
		...
		return c({
			...
			(y(!0), o(e, null, S(t.headers, (e) => (y(), i(Dt, {
				key: e.id,
				header: e,
				table: n.table
			}, null, 8, ["header", "table"]))), 128))
		]))), 128))])], 4)], 4), q.value.length > 0 && ue.value ? (y(), i(cn, {
			key: 0,
			rows: q.value,
			...
			class: "border-separate border-spacing-0 table-fixed w-full border-0 bg-transparent",
			style: g({ width: K.value + "px" })
		}, [s("tbody", null, [(y(), o(e, null, S(Sn, (t) => s("tr", { key: t }, [
			s("td", {
		...
		])), 64))])], 4)], 4)) : a("", !0)], 2), q.value.length === 0 && !k.value ? (y(), o("div", dn, [s("div", fn, [
			s("div", pn, [(y(), o("svg", mn, [...c[13] ||= [s("rect", {
				x: "3",
				y: "3",
				width: "18",
				height: "18",
			...
			s("div", hn, [s("p", gn, C(T(A)), 1), s("p", _n, C(T(j)), 1)]),
			v.value.insert ? (y(), o("div", vn, [
				L.value ? (y(), o("button", {
					key: 0,
					class: "flex items-center gap-1.5 px-3 py-1 rounded text-[13px] font-medium transition-colors",
					style: {
					...
					onClick: c[4] ||= (e) => T(R)()
				}, C(T(P)), 1)) : T(P) ? (y(), o("div", yn, [s("button", {
...
}, Tn = ["disabled"], En = { class: "flex items-center gap-1.5" }, Dn = ["value", "max"], On = {
	key: 1,
	class: "tabular-nums",
	style: { color: "var(--st-text)" }
}, kn = ["disabled"], An = { class: "flex items-center gap-1.5" }, jn = ["value"], Mn = {
	...
	stroke: "currentColor",
	"stroke-width": "2"
}, In = { style: { color: "var(--st-text-tertiary)" } }, Ln = {
	class: "text-[13px] mb-4",
	style: { color: "var(--st-text-secondary)" }
}, Rn = { class: "flex items-center justify-end gap-2" }, zn = {
	...
	setup(n, { emit: c }) {
		...
		return (r, c) => (y(), o("div", wn, [
			s("button", {
				...
				viewBox: "0 0 16 16",
				fill: "currentColor"
			}, [s("path", { d: "M9.78 12.78a.75.75 0 01-1.06 0L4.47 8.53a.75.75 0 010-1.06l4.25-4.25a.75.75 0 011.06 1.06L6.06 8l3.72 3.72a.75.75 0 010 1.06z" })], -1)]], 8, Tn),
			s("div", En, [
				...
				n.hasRandomAccess ? (y(), o("input", {
					...
					onChange: k
				}, null, 40, Dn)) : (y(), o("span", On, C(h.value + 1), 1)),
			...
			s("button", {
				...
				viewBox: "0 0 16 16",
				fill: "currentColor"
			}, [s("path", { d: "M6.22 3.22a.75.75 0 011.06 0l4.25 4.25a.75.75 0 010 1.06l-4.25 4.25a.75.75 0 01-1.06-1.06L9.94 8 6.22 4.28a.75.75 0 010-1.06z" })], -1)]], 8, kn),
			c[14] ||= s("div", {
				class: "w-px h-4 mx-1",
				style: { backgroundColor: "var(--st-border)" }
			}, null, -1),
			s("div", An, [c[10] ||= s("span", null, "Rows per page:", -1), s("select", {
				value: _.value,
			...
			n.stagedEdits && n.pendingEditCount > 0 ? (y(), o(e, { key: 0 }, [
				s("span", Mn, C(n.pendingEditCount) + " pending change" + C(n.pendingEditCount === 1 ? "" : "s"), 1),
				s("button", {
				...
				}, [n.committing ? (y(), o("svg", Fn, [...c[11] ||= [s("path", {
					d: "M8 1.5a6.5 6.5 0 1 1-6.5 6.5",
					"stroke-linecap": "round"
				}, null, -1)]])) : a("", !0), l(" " + C(n.committing ? "Committing…" : "Commit"), 1)], 8, Pn),
				c[12] ||= s("div", {
					class: "w-px h-4 mx-1",
					style: { backgroundColor: "var(--st-border)" }
				}, null, -1)
			], 64)) : a("", !0),
			s("span", In, C(D.value.toLocaleString()) + " " + C(D.value === 1 ? n.countLabelSingular : n.countLabelPlural), 1),
			(y(), i(t, { to: "body" }, [A.value ? (y(), o("div", {
				...
				s("p", Ln, " This will discard " + C(n.pendingEditCount) + " pending change" + C(n.pendingEditCount === 1 ? "" : "s") + ". This action cannot be undone. ", 1),
				s("div", Rn, [s("button", {
...
}, Vn = { class: "flex items-center gap-2" }, Hn = {
	class: "text-sm",
	style: { color: "var(--st-text)" }
}, Un = {
...
}, Wn = { class: "flex-1 overflow-auto px-5 py-4" }, Gn = {
	key: 0,
	class: "mb-6"
}, Kn = { class: "flex items-start gap-4" }, qn = { class: "w-40 shrink-0 pt-2" }, Jn = {
	class: "text-[13px] font-medium",
	style: { color: "var(--st-text)" }
}, Yn = {
	class: "text-xs",
	style: { color: "var(--st-text-tertiary)" }
}, Xn = { class: "flex-1" }, Zn = ["disabled", "onClick"], Qn = {
	class: "text-xs",
	style: { color: "var(--st-text-secondary)" }
}, $n = ["value"], er = ["onUpdate:modelValue", "placeholder"], tr = { key: 1 }, nr = { class: "flex items-start gap-4" }, rr = { class: "w-40 shrink-0 pt-2" }, ir = {
	class: "text-[13px] font-medium",
	style: { color: "var(--st-text)" }
}, ar = {
	class: "text-xs",
	style: { color: "var(--st-text-tertiary)" }
}, or = { class: "flex-1" }, sr = ["disabled", "onClick"], cr = {
	class: "text-xs",
	style: { color: "var(--st-text-secondary)" }
}, lr = ["value"], ur = ["onUpdate:modelValue", "placeholder"], dr = {
	...
	setup(t, { emit: n }) {
		...
		return _(() => {
			...
			s("div", Bn, [s("div", Vn, [s("span", Hn, C(t.mode === "insert" ? "Insert row into" : "Update row from"), 1), s("code", Un, C(t.tableName), 1)]), s("button", {
			...
			s("div", Wn, [m.value.length > 0 ? (y(), o("div", Gn, [(y(!0), o(e, null, S(m.value, (n) => (y(), o("div", {
				key: n.id,
				class: "mb-4"
			}, [s("div", Kn, [s("div", qn, [s("div", Jn, C(n.id), 1), s("div", Yn, C(n.meta.type), 1)]), s("div", Xn, [n.meta.type === "boolean" ? (y(), o("button", {
				key: 0,
			...
			}, [s("span", { class: h(["absolute top-[2px] w-[14px] h-[14px] rounded-full bg-white transition-transform", w.value[n.id] ? "left-[17px]" : "left-[2px]"]) }, null, 2)], 4), s("span", Qn, C(w.value[n.id] ? "true" : "false"), 1)], 10, Zn)) : (y(), o(e, { key: 1 }, [n.meta.isPrimaryKey && t.mode === "update" || n.meta.readOnly && t.mode === "insert" ? (y(), o("input", {
				key: 0,
				value: w.value[n.id],
			...
			}, null, 8, er)), [[O, w.value[n.id]]])], 64))])])]))), 128))])) : a("", !0), b.value.length > 0 ? (y(), o("div", tr, [r[3] ||= s("div", { class: "mb-3" }, [s("h3", {
				...
				key: n.id,
				class: "mb-4"
			}, [s("div", nr, [s("div", rr, [s("div", ir, C(n.id), 1), s("div", ar, C(n.meta.type), 1)]), s("div", or, [n.meta.type === "boolean" ? (y(), o("button", {
				key: 0,
				class: h(["flex items-center gap-2", { "opacity-50 cursor-not-allowed": n.meta.readOnly && t.mode === "insert" }]),
				disabled: n.meta.readOnly && t.mode === "insert",
				onClick: (e) => !(n.meta.readOnly && t.mode === "insert") && (w.value[n.id] = !w.value[n.id])
				...
				class: "inline-block w-8 h-[18px] rounded-full relative transition-colors",
				style: g({ backgroundColor: w.value[n.id] ? "var(--st-accent)" : "var(--st-toggle-off)" })
			}, [s("span", { class: h(["absolute top-[2px] w-[14px] h-[14px] rounded-full bg-white transition-transform", w.value[n.id] ? "left-[17px]" : "left-[2px]"]) }, null, 2)], 4), s("span", cr, C(w.value[n.id] ? "true" : "false"), 1)], 10, sr)) : (y(), o(e, { key: 1 }, [n.meta.readOnly && t.mode === "insert" ? (y(), o("input", {
				key: 0,
				value: w.value[n.id],
				class: "w-full rounded px-3 py-2 text-[13px] outline-none cursor-not-allowed",
				style: {
			...
			}, null, 8, ur)), [[O, w.value[n.id]]])], 64))])])]))), 128))])) : a("", !0)]),
			s("div", dr, [s("button", {
	...
	class: "my-1",
	style: { borderTop: "1px solid var(--st-border-secondary)" }
}, vr = ["disabled", "onClick"], yr = ["innerHTML"], br = {
	class: "w-3.5 h-3.5",
	style: { color: "var(--st-text-secondary)" },
	viewBox: "0 0 16 16",
	fill: "currentColor"
	...
	setup(n, { emit: c }) {
		...
		return (r, c) => (y(), i(t, { to: "body" }, [s("div", {
			...
			s("button", {
				...
				style: { color: "var(--st-text)" },
				onClick: F
			}, [(y(), o("svg", gr, [...c[4] ||= [s("path", { d: "M.75 3a.75.75 0 000 1.5h14.5a.75.75 0 000-1.5H.75zM3 7.75A.75.75 0 013.75 7h8.5a.75.75 0 010 1.5h-8.5A.75.75 0 013 7.75zm3 4a.75.75 0 01.75-.75h2.5a.75.75 0 010 1.5h-2.5a.75.75 0 01-.75-.75z" }, null, -1)]])), c[5] ||= l(" Filter by value ", -1)]),
			...
			n.customActions.length > 0 ? (y(), o(e, { key: 1 }, [c[9] ||= s("div", {
				class: "my-1",
				style: { borderTop: "1px solid var(--st-border-secondary)" }
			}, null, -1), (y(!0), o(e, null, S(n.customActions, (t, n) => (y(), o(e, { key: t.divider ? `divider-${n}` : t.key }, [t.divider ? (y(), o("div", _r)) : (y(), o("button", {
				key: 1,
				type: "button",
				...
				class: "shrink-0 w-3.5 h-3.5 inline-flex items-center justify-center [&_svg]:max-w-full [&_svg]:max-h-full",
				innerHTML: t.icon
			}, null, 8, yr)) : a("", !0), s("span", null, C(t.label), 1)], 14, vr))], 64))), 128))], 64)) : a("", !0),
			T(u).update || T(u).delete ? (y(), o(e, { key: 2 }, [
				...
				T(u).update ? (y(), o("button", {
					...
					style: { color: "var(--st-text)" },
					onClick: I
				}, [(y(), o("svg", br, [...c[10] ||= [s("path", { d: "M11.013 1.427a1.75 1.75 0 012.474 0l1.086 1.086a1.75 1.75 0 010 2.474l-8.61 8.61c-.21.21-.47.364-.756.445l-3.251.93a.75.75 0 01-.927-.928l.929-3.25a1.75 1.75 0 01.445-.758l8.61-8.61z" }, null, -1)]])), c[11] ||= l(" Edit row ", -1)])) : a("", !0),
...
}, [["__scopeId", "data-v-d0de0629"]]), Sr = { class: "px-5 pt-5 pb-4" }, Cr = { style: { color: "var(--st-text-secondary)" } }, wr = {
	class: "px-5 py-3 flex items-center justify-end gap-2",
	style: { borderTop: "1px solid var(--st-border-secondary)" }
}, Tr = {
	...
	setup(e, { emit: n }) {
		...
		return (n, c) => (y(), i(t, { to: "body" }, [e.modelValue ? (y(), o("div", {
			...
			style: { color: "var(--st-text)" }
		}, "Confirm deletion", -1), s("p", Cr, " Are you sure you want to delete " + C(e.rowCount) + " row" + C(e.rowCount > 1 ? "s" : "") + "? This action cannot be undone. ", 1)]), s("div", wr, [s("button", {
			type: "button",
			class: "px-3 py-1.5 rounded text-[13px] transition-colors",
			style: {
				border: "1px solid var(--st-border-secondary)",
...
function Dr(e, t) {
	let n = e.length, r = {};
	if (n === 0) return r;
	let i = Math.max(Er * n, Math.floor(t)), a = Math.floor(i / n), o = i - a * n;
...
var kr = ["data-st-theme"], Ar = {
...
}, jr = { class: "flex-1" }, Mr = { class: "flex flex-1 min-h-0 min-w-0" }, Nr = { class: "flex flex-col flex-1 min-w-0 min-h-0" }, Pr = "-apple-system, BlinkMacSystemFont, \"Segoe UI\", Roboto, \"Helvetica Neue\", Arial, sans-serif", Fr = /* @__PURE__ */ H({
	__name: "DataTable",
	props: {
		columns: {
			type: Array,
	...
	setup(t, { expose: c, emit: l }) {
		...
		b(f, O);
		let A = r(() => ({ "--dt-font-family": O.value || Pr })), M = r(() => ({
			...E.value,
			...A.value,
			backgroundColor: "var(--st-bg)",
			color: "var(--st-text)"
		...
		return _(() => {
			...
			s("div", Mr, [s("div", Nr, [u(Cn, {
				...
				onContextMenu: Xe,
				onEditRow: Ve
			}, null, 8, ["table"]), t.showPagination ? (y(), i(zn, {
				key: 0,
				table: T($),
				...
				default: j(() => [(U.value.insert || U.value.update) && Re.value.open ? (y(), i(fr, {
					key: 0,
					mode: Re.value.mode,
