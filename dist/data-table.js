...
var mt = {
...
}, Rt = ["title"], zt = ["title"], Bt = ["innerHTML"], Vt = ["title", "onClick"], Ht = ["innerHTML"], Ut = {
	key: 1,
	class: "text-[11px]"
}, Wt = {
	__name: "TableCell",
	...
	setup(t, { emit: n }) {
		...
		let J = r(() => {
			...
			let i = String(r).trim();
			return i === "" ? null : i;
		}), re = r(() => c.cell.getValue() == null), ie = r(() => ne.value ? re.value ? !0 : !J.value : !1), X = r(() => ie.value ? "flex items-start gap-1 min-w-0" : "flex items-center gap-1 min-w-0");
		function ae() {
			L.value || I("select");
		}
		function oe() {
			!u.value?.update || te.value || H.value.progressBar || K.value.length > 0 || (L.value = !0, I("editing-change", !0), R.value = c.cell.getValue() ?? "", m(() => {
				z.value && (z.value.focus(), z.value.select(), se());
			}));
		}
		function se() {
		...
		function le(e) {
			e.key === "Enter" && !e.shiftKey ? (e.preventDefault(), ce()) : e.key === "Escape" && Z();
		}
		function ue() {
		...
		return (n, r) => (y(), o("div", {
			...
			}, C(t.cell.getValue()), 9, Rt)), ie.value ? (y(), o("span", {
				key: 4,
				class: h(["block text-[11px] leading-snug", G.value === "wrap" ? "whitespace-pre-wrap break-words" : "truncate"]),
				style: { color: "var(--st-text-secondary)" },
				title: G.value === "wrap" ? void 0 : ne.value
			}, C(ne.value), 11, zt)) : a("", !0)]),
			Y.value ? (y(), o("span", {
				key: 0,
				class: "w-3.5 h-3.5 shrink-0 flex items-center justify-center",
			...
			K.value.length > 0 ? (y(), o("div", {
				...
				innerHTML: e.icon
			}, null, 8, Ht)) : (y(), o("span", Ut, C(e.label), 1))], 8, Vt))), 128))], 2)) : a("", !0)
		], 6)) : (y(), o("div", Mt, [s("div", Nt, [s("div", {
...
}, qt = { class: "flex h-full gap-1 pr-1.5 pl-1 items-center justify-end pl-0.5" }, Jt = { class: "flex min-w-0 flex-1 items-center justify-end gap-0.5" }, Yt = {
	class: "text-xs text-right whitespace-nowrap",
	style: { color: "var(--st-text-tertiary)" }
}, Xt = ["checked"], Zt = /* @__PURE__ */ V({
	...
	setup(t) {
		...
		return (n, r) => (y(), o("div", {
			...
			s("div", {
			...
			}, [s("div", qt, [s("div", Jt, [R() ? (y(), o("button", {
				key: 0,
				...
				stroke: "currentColor",
				"stroke-width": "2"
			}, [s("path", { d: "M6 2h8v8M14 2L6 10" })], -1)]])) : a("", !0), s("span", Yt, C(t.orderNumber), 1)])])], 4),
			s("div", {
			...
			(y(!0), o(e, null, S(t.row.getVisibleCells(), (e) => (y(), i(Wt, {
				key: e.id,
				cell: e,
...
}, [["__scopeId", "data-v-9f93e669"]]), Qt = 36, $t = 56, en = 40, tn = 300, nn = {
	...
	setup(n, { expose: c, emit: u }) {
		...
		let oe = r(() => {
			...
			return e ? `${e}, ${t}` : t;
		}), se = r(() => U.value.length > gn), ce = E("scroller");
		function Z(e, t) {
			z.value = e ? t : null;
		}
		function le() {
		...
		return c({
		...
		]))), 128))])], 4)], 4), U.value.length > 0 && se.value ? (y(), i(nn, {
			key: 0,
			rows: U.value,
			...
			class: "border-separate border-spacing-0 table-fixed w-full border-0 bg-transparent",
			style: g({ width: H.value + "px" })
		}, [s("tbody", null, [(y(), o(e, null, S(_n, (t) => s("tr", { key: t }, [
			s("td", {
		...
		])), 64))])], 4)], 4)) : a("", !0)], 2), U.value.length === 0 && !k.value ? (y(), o("div", on, [s("div", sn, [
			...
			s("div", un, [s("p", dn, C(T(A)), 1), s("p", fn, C(T(j)), 1)]),
			v.value.insert ? (y(), o("div", pn, [
				T(N) ? (y(), o("div", mn, [s("button", {
	...
	setup(n, { emit: c }) {
		...
		return (r, c) => (y(), i(t, { to: "body" }, [s("div", {
			...
			s("button", {
				...
				style: { color: "var(--st-text)" },
				onClick: N
			}, [(y(), o("svg", dr, [...c[4] ||= [s("path", { d: "M.75 3a.75.75 0 000 1.5h14.5a.75.75 0 000-1.5H.75zM3 7.75A.75.75 0 013.75 7h8.5a.75.75 0 010 1.5h-8.5A.75.75 0 013 7.75zm3 4a.75.75 0 01.75-.75h2.5a.75.75 0 010 1.5h-2.5a.75.75 0 01-.75-.75z" }, null, -1)]])), c[5] ||= l(" Filter by value ", -1)]),
			...
			n.customActions.length > 0 ? (y(), o(e, { key: 1 }, [c[9] ||= s("div", {
				...
				class: "shrink-0 w-3.5 h-3.5 inline-flex items-center justify-center [&_svg]:max-w-full [&_svg]:max-h-full",
				innerHTML: e.icon
			}, null, 8, pr)) : a("", !0), s("span", null, C(e.label), 1)], 12, fr))), 128))], 64)) : a("", !0),
			T(u).update || T(u).delete ? (y(), o(e, { key: 2 }, [
				...
				T(u).update ? (y(), o("button", {
					...
					style: { color: "var(--st-text)" },
					onClick: P
				}, [(y(), o("svg", mr, [...c[10] ||= [s("path", { d: "M11.013 1.427a1.75 1.75 0 012.474 0l1.086 1.086a1.75 1.75 0 010 2.474l-8.61 8.61c-.21.21-.47.364-.756.445l-3.251.93a.75.75 0 01-.927-.928l.929-3.25a1.75 1.75 0 01.445-.758l8.61-8.61z" }, null, -1)]])), c[11] ||= l(" Edit row ", -1)])) : a("", !0),
...
}, [["__scopeId", "data-v-6787adf2"]]), gr = { class: "px-5 pt-5 pb-4" }, _r = { style: { color: "var(--st-text-secondary)" } }, vr = {
	class: "px-5 py-3 flex items-center justify-end gap-2",
	style: { borderTop: "1px solid var(--st-border-secondary)" }
}, yr = {
	...
	setup(e, { emit: n }) {
		...
		return (n, c) => (y(), i(t, { to: "body" }, [e.modelValue ? (y(), o("div", {
			...
			style: { color: "var(--st-text)" }
		}, "Confirm deletion", -1), s("p", _r, " Are you sure you want to delete " + C(e.rowCount) + " row" + C(e.rowCount > 1 ? "s" : "") + "? This action cannot be undone. ", 1)]), s("div", vr, [s("button", {
			type: "button",
			class: "px-3 py-1.5 rounded text-[13px] transition-colors",
			style: {
				border: "1px solid var(--st-border-secondary)",
...
function xr(e, t) {
	let n = e.length, r = {};
	if (n === 0) return r;
	let i = Math.max(br * n, Math.floor(t)), a = Math.floor(i / n), o = i - a * n;
...
var Cr = ["data-st-theme"], wr = {
...
}, Tr = { class: "flex-1" }, Er = { class: "flex flex-1 min-h-0 min-w-0" }, Dr = { class: "flex flex-col flex-1 min-w-0 min-h-0" }, Or = "-apple-system, BlinkMacSystemFont, \"Segoe UI\", Roboto, \"Helvetica Neue\", Arial, sans-serif", kr = /* @__PURE__ */ V({
	__name: "DataTable",
	props: {
		columns: {
			type: Array,
	...
	setup(t, { expose: c, emit: l }) {
		...
		b(f, O);
		let A = r(() => ({ "--dt-font-family": O.value || Or })), ee = r(() => ({
			...E.value,
			...A.value,
			backgroundColor: "var(--st-bg)",
			color: "var(--st-text)"
