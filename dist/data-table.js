...
var V = (e, t) => {
	...
	setup(n, { emit: c }) {
		...
		function ne(e) {
			v.value === "columns" ? re(e) : v.value === "operators" ? ie(e) : e.key !== "Escape" && K(), e.key === "Escape" && (ae(), D.value?.blur());
		}
		function re(e) {
			let t = z.value;
			if (t.length !== 0) {
		...
		return k(w, () => {
			...
			s("div", {
				...
				}, [s("span", Me, C(e.id), 1), T(f) ? (y(), o("span", Ne, C(e.type), 1)) : a("", !0)], 44, je))), 128)), R.value.length === 0 ? (y(), o("div", Pe, " No columns found ")) : a("", !0)], 4)) : a("", !0)])),
				...
				}, [(y(!0), o(e, null, S(I.value, (t, n) => (y(), o(e, { key: n }, [t.type === "header" ? (y(), o("div", Fe, C(t.label), 1)) : (y(), o("div", {
					key: 1,
					class: "flex items-center justify-between px-3 py-1.5 cursor-pointer text-[13px]",
...
var mt = {
	...
	setup(t, { emit: n }) {
		...
		}), ne = r(() => U.value && !H.value.badge), re = r(() => {
			let e = H.value;
		...
		function ce() {
			!u.value?.update || ne.value || H.value.progressBar || H.value.segmentedBar || J.value.length > 0 || (L.value = !0, I("editing-change", !0), R.value = c.cell.getValue() ?? "", m(() => {
				z.value && (z.value.focus(), z.value.select(), Z());
			}));
		}
		function Z() {
	...
	setup(n, { expose: c, emit: u }) {
		...
		}), b = d("showRowBorders", !0), D = d("showColumnBorders", !0), O = d("loading", !1), k = r(() => !!T(O)), A = d("emptyTitle", "No rows found"), j = d("emptyMessage", "Get started by inserting a new row."), ee = d("openInsertPanel", null), N = d("defaultInsertLabel", null), P = d("insertRow", () => {}), F = x(!1), I = d("nestingDepth", 0), L = u, R = x(null), z = x(null), B = d("tableSourceRows", null), V = r(() => (B != null && w(B), m.table.getHeaderGroups())), H = r(() => 84 + m.table.getVisibleLeafColumns().reduce((e, t) => e + t.getSize(), 0)), U = r(() => (B != null && w(B), m.table.getRowModel().rows)), W = r(() => (B != null && w(B), m.table.getVisibleLeafColumns())), G = r(() => m.table.getState().pagination), K = d("isRowDisplayedSelected", null);
		function q(e) {
			let t = T(K);
			return typeof t == "function" ? t(e) : e.getIsSelected();
		}
		let J = r(() => U.value.length ? U.value.every((e) => q(e)) : !1), te = r(() => {
			if (!U.value.length) return !1;
			let e = U.value.some((e) => q(e)), t = U.value.every((e) => q(e));
			return e && !t;
		});
		function Y(e, t) {
			R.value = `${e}:${t}`;
		...
		function ae(e, t, n) {
			if (t?.shiftKey && X.value !== null) {
				let e = Math.min(X.value, n), t = Math.max(X.value, n), r = U.value;
		...
		let oe = r(() => {
			...
			return e ? `${e}, ${t}` : t;
		}), se = r(() => U.value.length > bn), ce = E("scroller");
		function Z(e, t) {
			z.value = e ? t : null;
		}
		function le() {
		...
		return c({
		...
		}), (r, c) => (y(), o("div", { class: h(T(I) === 0 ? "flex-1 min-h-0 relative" : "overflow-auto") }, [s("div", {
			ref: "scroller",
			class: h(T(I) === 0 ? "absolute inset-0 overflow-auto flex flex-col items-start min-h-0" : "flex flex-col items-start"),
			...
			style: g({ width: H.value + "px" })
		}, [s("thead", null, [(y(!0), o(e, null, S(V.value, (t) => (y(), o("tr", { key: t.id }, [
			s("th", {
		...
		]))), 128))])], 4)], 4), U.value.length > 0 && se.value ? (y(), i(sn, {
			key: 0,
			rows: U.value,
			"scroll-element-ref": ce.value,
			"total-table-width": H.value,
			"selected-cell": R.value,
			"editing-row-id": z.value,
			"pagination-state": G.value,
			onToggleRowSelect: ae,
			onEditRow: c[0] ||= (e) => L("edit-row", e),
			onContextMenu: re,
			onSelectCell: Y,
			onUpdateCell: c[1] ||= (e, t, n) => L("update-cell", e, t, n),
			onEditingChange: Z
		}, null, 8, [
			"rows",
			"scroll-element-ref",
			...
			"pagination-state": G.value,
			onToggleRowSelect: ae,
			onEditRow: c[2] ||= (e) => L("edit-row", e),
			onContextMenu: re,
			onSelectCell: Y,
			onUpdateCell: c[3] ||= (e, t, n) => L("update-cell", e, t, n),
			onEditingChange: Z
		}, null, 8, [
			"rows",
			"total-table-width",
			...
			(y(!0), o(e, null, S(W.value, (e, n) => (y(), o("td", {
				key: e.id,
		...
		])), 64))])], 4)], 4)) : a("", !0)], 2), U.value.length === 0 && !k.value ? (y(), o("div", un, [s("div", dn, [
			...
			v.value.insert ? (y(), o("div", _n, [
				...
				F.value ? (y(), o("div", yn, [
					...
					s("button", {
						class: "w-full text-left px-3 py-1.5 hover-menu-item",
						style: { color: "var(--st-text)" },
						onClick: c[9] ||= (e) => F.value = !1
					}, " Import data from CSV ")
				])) : a("", !0),
				(y(), i(t, { to: "body" }, [F.value ? (y(), o("div", {
					key: 0,
					class: "fixed inset-0 z-40",
					onClick: c[10] ||= (e) => F.value = !1
				})) : a("", !0)]))
			])) : a("", !0)
		])])) : a("", !0)], 2));
	}
...
var Dr = ["data-st-theme"], Or = {
	...
	setup(t, { expose: c, emit: l }) {
		...
		let W = x(p.controlledSorting ?? []), G = x(p.controlledColumnFilters ?? p.columnFilters ?? []), K = x({}), q = x({
			pageIndex: 0,
			pageSize: 100
		}), J = x({}), te = x({
			startOffset: null,
		...
		let Ne = R({
			...
			onSortingChange: (e) => {
				W.value = typeof e == "function" ? e(W.value) : e, Z.value && V("sort-change", W.value);
			},
			...
			onPaginationChange: (e) => {
				...
				q.value = t, Z.value && V("page-change", {
			...
			onColumnSizingInfoChange: (e) => {
				...
				te.value = n, t.isResizingColumn && !n.isResizingColumn && V("column-resize", J.value);
			},
		...
		return _(() => {
			...
			s("div", Ar, [s("div", jr, [u(Sn, {
				...
				default: j(() => [(H.value.insert || H.value.update) && Re.value.open ? (y(), i(dr, {
					key: 0,
					mode: Re.value.mode,
