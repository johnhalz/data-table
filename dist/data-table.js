...
var mt = {
...
}, Rt = ["title"], zt = ["innerHTML"], Bt = ["title", "onClick"], Vt = ["innerHTML"], Ht = {
	key: 1,
	class: "text-[11px]"
}, Ut = {
	__name: "TableCell",
	...
	setup(t, { emit: n }) {
		...
		return (n, r) => (y(), o("div", {
			...
			s("div", Ft, [t.cell.getValue() === null || t.cell.getValue() === void 0 ? (y(), o("span", It, "NULL")) : J.value ? (y(), o("span", {
				key: 1,
				class: "inline-flex items-center px-1.5 py-0.5 rounded text-[11px] font-medium leading-tight",
				style: g(J.value.style)
			}, C(J.value.text), 5)) : G.value === "wrap" ? (y(), o("span", Lt, C(t.cell.getValue()), 1)) : (y(), o("span", {
				key: 3,
				class: "truncate block",
				title: String(t.cell.getValue())
			}, C(t.cell.getValue()), 9, Rt))]),
			Y.value ? (y(), o("span", {
				key: 0,
				class: "w-3.5 h-3.5 shrink-0 flex items-center justify-center",
			...
			K.value.length > 0 ? (y(), o("div", {
				...
				innerHTML: e.icon
			}, null, 8, Vt)) : (y(), o("span", Ht, C(e.label), 1))], 8, Bt))), 128))], 2)) : a("", !0)
		], 4)) : (y(), o("div", Mt, [s("div", Nt, [s("div", {
			class: "h-full rounded-full transition-all duration-300",
			style: g({
				width: `${W.value}%`,
				backgroundColor: "var(--st-accent)"
			})
		}, null, 4)]), s("span", Pt, C(Math.round(W.value)) + "% ", 1)]))], 44, Dt));
	}
}, Wt = ["data-index"], Gt = {
	class: "group/row",
	style: {
...
}, Kt = { class: "flex h-full gap-1 pr-1.5 pl-1 items-center justify-end pl-0.5" }, qt = { class: "flex min-w-0 flex-1 items-center justify-end gap-0.5" }, Jt = {
	class: "text-xs text-right whitespace-nowrap",
	style: { color: "var(--st-text-tertiary)" }
}, Yt = ["checked"], Xt = /* @__PURE__ */ V({
	...
	setup(t) {
		...
		return (n, r) => (y(), o("div", {
			...
			s("div", {
			...
			}, [s("div", Kt, [s("div", qt, [R() ? (y(), o("button", {
				key: 0,
				...
				stroke: "currentColor",
				"stroke-width": "2"
			}, [s("path", { d: "M6 2h8v8M14 2L6 10" })], -1)]])) : a("", !0), s("span", Jt, C(t.orderNumber), 1)])])], 4),
			s("div", {
			...
			(y(!0), o(e, null, S(t.row.getVisibleCells(), (e) => (y(), i(Ut, {
				key: e.id,
				cell: e,
...
}, [["__scopeId", "data-v-9f93e669"]]), Zt = 36, Qt = 56, $t = 40, en = 300, tn = {
	...
	setup(t, { emit: n }) {
		let a = t, s = n, c = d("cellOverflow", "truncate"), l = d("getSubTable", null), u = d("expanded"), f = typeof window < "u" && "onscrollend" in window, p = r(() => T(u) ?? {}), m = B(r(() => {
			...
			return {
				...
				estimateSize: (i) => {
					...
					if (!a) return Zt;
					let o = n ? Qt : Zt;
					return r[a.id] ? t[a.id] ? Math.max(o, en) : Math.max(o, $t) : o;
				},
				overscan: 8,
		...
		return (n, r) => (y(), o("div", { style: g({
			...
			height: _.value + "px",
			width: t.totalTableWidth + "px"
		}) }, [(y(!0), o(e, null, S(h.value, (e) => (y(), i(Xt, {
			key: e.key,
			ref_for: !0,
			ref: (t) => v(t, e),
			row: t.rows[e.index],
	...
	setup(t, { emit: n }) {
		...
		}, [(y(!0), o(e, null, S(t.rows, (e, n) => (y(), i(Xt, {
			key: e.id,
			row: e,
			"row-index": n,
...
}, rn = ["checked", "indeterminate"], an = {
	key: 0,
	class: "absolute inset-0 flex items-center justify-center pointer-events-none",
	style: { top: "33px" }
}, on = { class: "flex flex-col items-center gap-4 text-center px-6 pointer-events-auto" }, sn = {
	...
	style: { color: "var(--st-accent)" }
}, ln = { class: "flex flex-col gap-1" }, un = {
	...
	setup(n, { expose: c, emit: u }) {
		...
		let oe = r(() => {
			...
			return e ? `${e}, ${t}` : t;
		}), se = r(() => U.value.length > hn), ce = E("scroller");
		function le(e, t) {
			z.value = e ? t : null;
		}
		function ue() {
		...
		return c({
		...
		]))), 128))])], 4)], 4), U.value.length > 0 && se.value ? (y(), i(tn, {
			key: 0,
			rows: U.value,
			...
			class: "border-separate border-spacing-0 table-fixed w-full border-0 bg-transparent",
			style: g({ width: H.value + "px" })
		}, [s("tbody", null, [(y(), o(e, null, S(gn, (t) => s("tr", { key: t }, [
			s("td", {
		...
		])), 64))])], 4)], 4)) : a("", !0)], 2), U.value.length === 0 && !k.value ? (y(), o("div", an, [s("div", on, [
			s("div", sn, [(y(), o("svg", cn, [...c[12] ||= [s("rect", {
				x: "3",
				y: "3",
				width: "18",
				height: "18",
			...
			s("div", ln, [s("p", un, C(T(A)), 1), s("p", dn, C(T(j)), 1)]),
			v.value.insert ? (y(), o("div", fn, [
				T(N) ? (y(), o("div", pn, [s("button", {
		...
		return (r, c) => (y(), o("div", vn, [
			...
			s("div", bn, [
				...
				n.hasRandomAccess ? (y(), o("input", {
					...
					onChange: k
				}, null, 40, xn)) : (y(), o("span", Sn, C(h.value + 1), 1)),
			...
			n.stagedEdits && n.pendingEditCount > 0 ? (y(), o(e, { key: 0 }, [
				s("span", En, C(n.pendingEditCount) + " pending change" + C(n.pendingEditCount === 1 ? "" : "s"), 1),
				s("button", {
				...
				s("button", {
					...
					"stroke-linecap": "round"
				}, null, -1)]])) : a("", !0), l(" " + C(n.committing ? "Committing…" : "Commit"), 1)], 8, On),
				c[12] ||= s("div", {
					class: "w-px h-4 mx-1",
					style: { backgroundColor: "var(--st-border)" }
				}, null, -1)
			], 64)) : a("", !0),
			s("span", An, C(D.value.toLocaleString()) + " " + C(D.value === 1 ? n.countLabelSingular : n.countLabelPlural), 1),
			(y(), i(t, { to: "body" }, [A.value ? (y(), o("div", {
				...
				s("p", jn, " This will discard " + C(n.pendingEditCount) + " pending change" + C(n.pendingEditCount === 1 ? "" : "s") + ". This action cannot be undone. ", 1),
				s("div", Mn, [s("button", {
	...
	setup(t, { emit: n }) {
		...
		return _(() => {
			...
			s("div", Pn, [s("div", Fn, [s("span", In, C(t.mode === "insert" ? "Insert row into" : "Update row from"), 1), s("code", Ln, C(t.tableName), 1)]), s("button", {
			...
			s("div", Rn, [m.value.length > 0 ? (y(), o("div", zn, [(y(!0), o(e, null, S(m.value, (n) => (y(), o("div", {
				key: n.id,
				class: "mb-4"
			}, [s("div", Bn, [s("div", Vn, [s("div", Hn, C(n.id), 1), s("div", Un, C(n.meta.type), 1)]), s("div", Wn, [n.meta.type === "boolean" ? (y(), o("button", {
				key: 0,
			...
			}, [s("span", { class: h(["absolute top-[2px] w-[14px] h-[14px] rounded-full bg-white transition-transform", w.value[n.id] ? "left-[17px]" : "left-[2px]"]) }, null, 2)], 4), s("span", Kn, C(w.value[n.id] ? "true" : "false"), 1)], 10, Gn)) : (y(), o(e, { key: 1 }, [n.meta.isPrimaryKey && t.mode === "update" || n.meta.readOnly && t.mode === "insert" ? (y(), o("input", {
				key: 0,
				value: w.value[n.id],
			...
			}, null, 8, Jn)), [[O, w.value[n.id]]])], 64))])])]))), 128))])) : a("", !0), b.value.length > 0 ? (y(), o("div", Yn, [r[3] ||= s("div", { class: "mb-3" }, [s("h3", {
				...
				key: n.id,
				class: "mb-4"
			}, [s("div", Xn, [s("div", Zn, [s("div", Qn, C(n.id), 1), s("div", $n, C(n.meta.type), 1)]), s("div", er, [n.meta.type === "boolean" ? (y(), o("button", {
				key: 0,
				class: h(["flex items-center gap-2", { "opacity-50 cursor-not-allowed": n.meta.readOnly && t.mode === "insert" }]),
				disabled: n.meta.readOnly && t.mode === "insert",
				onClick: (e) => !(n.meta.readOnly && t.mode === "insert") && (w.value[n.id] = !w.value[n.id])
				...
				class: "inline-block w-8 h-[18px] rounded-full relative transition-colors",
				style: g({ backgroundColor: w.value[n.id] ? "var(--st-accent)" : "var(--st-toggle-off)" })
			}, [s("span", { class: h(["absolute top-[2px] w-[14px] h-[14px] rounded-full bg-white transition-transform", w.value[n.id] ? "left-[17px]" : "left-[2px]"]) }, null, 2)], 4), s("span", nr, C(w.value[n.id] ? "true" : "false"), 1)], 10, tr)) : (y(), o(e, { key: 1 }, [n.meta.readOnly && t.mode === "insert" ? (y(), o("input", {
				key: 0,
				value: w.value[n.id],
				class: "w-full rounded px-3 py-2 text-[13px] outline-none cursor-not-allowed",
				style: {
			...
			}, null, 8, ir)), [[O, w.value[n.id]]])], 64))])])]))), 128))])) : a("", !0)]),
			s("div", ar, [s("button", {
	...
	setup(n, { emit: c }) {
		...
		return (r, c) => (y(), i(t, { to: "body" }, [s("div", {
			...
			s("button", {
				...
				style: { color: "var(--st-text)" },
				onClick: N
			}, [(y(), o("svg", ur, [...c[4] ||= [s("path", { d: "M.75 3a.75.75 0 000 1.5h14.5a.75.75 0 000-1.5H.75zM3 7.75A.75.75 0 013.75 7h8.5a.75.75 0 010 1.5h-8.5A.75.75 0 013 7.75zm3 4a.75.75 0 01.75-.75h2.5a.75.75 0 010 1.5h-2.5a.75.75 0 01-.75-.75z" }, null, -1)]])), c[5] ||= l(" Filter by value ", -1)]),
			...
			n.customActions.length > 0 ? (y(), o(e, { key: 1 }, [c[9] ||= s("div", {
				...
				class: "shrink-0 w-3.5 h-3.5 inline-flex items-center justify-center [&_svg]:max-w-full [&_svg]:max-h-full",
				innerHTML: e.icon
			}, null, 8, fr)) : a("", !0), s("span", null, C(e.label), 1)], 12, dr))), 128))], 64)) : a("", !0),
			T(u).update || T(u).delete ? (y(), o(e, { key: 2 }, [
				...
				T(u).update ? (y(), o("button", {
					...
					style: { color: "var(--st-text)" },
					onClick: P
				}, [(y(), o("svg", pr, [...c[10] ||= [s("path", { d: "M11.013 1.427a1.75 1.75 0 012.474 0l1.086 1.086a1.75 1.75 0 010 2.474l-8.61 8.61c-.21.21-.47.364-.756.445l-3.251.93a.75.75 0 01-.927-.928l.929-3.25a1.75 1.75 0 01.445-.758l8.61-8.61z" }, null, -1)]])), c[11] ||= l(" Edit row ", -1)])) : a("", !0),
...
}, [["__scopeId", "data-v-6787adf2"]]), hr = { class: "px-5 pt-5 pb-4" }, gr = { style: { color: "var(--st-text-secondary)" } }, _r = {
	class: "px-5 py-3 flex items-center justify-end gap-2",
	style: { borderTop: "1px solid var(--st-border-secondary)" }
}, vr = {
	...
	setup(e, { emit: n }) {
		...
		return (n, c) => (y(), i(t, { to: "body" }, [e.modelValue ? (y(), o("div", {
			...
			style: { color: "var(--st-text)" }
		}, "Confirm deletion", -1), s("p", gr, " Are you sure you want to delete " + C(e.rowCount) + " row" + C(e.rowCount > 1 ? "s" : "") + "? This action cannot be undone. ", 1)]), s("div", _r, [s("button", {
			type: "button",
			class: "px-3 py-1.5 rounded text-[13px] transition-colors",
			style: {
				border: "1px solid var(--st-border-secondary)",
...
function br(e, t) {
	let n = e.length, r = {};
	if (n === 0) return r;
	let i = Math.max(yr * n, Math.floor(t)), a = Math.floor(i / n), o = i - a * n;
...
var Sr = ["data-st-theme"], Cr = {
...
}, wr = { class: "flex-1" }, Tr = { class: "flex flex-1 min-h-0 min-w-0" }, Er = { class: "flex flex-col flex-1 min-w-0 min-h-0" }, Dr = "-apple-system, BlinkMacSystemFont, \"Segoe UI\", Roboto, \"Helvetica Neue\", Arial, sans-serif", Or = /* @__PURE__ */ V({
	__name: "DataTable",
	props: {
		columns: {
			type: Array,
	...
	setup(t, { expose: c, emit: l }) {
		...
		b(f, O);
		let A = r(() => ({ "--dt-font-family": O.value || Dr })), ee = r(() => ({
			...E.value,
			...A.value,
			backgroundColor: "var(--st-bg)",
			color: "var(--st-text)"
		...
		return _(() => {
			...
			s("div", Tr, [s("div", Er, [u(_n, {
				...
				default: j(() => [(H.value.insert || H.value.update) && Re.value.open ? (y(), i(or, {
					key: 0,
					mode: Re.value.mode,
