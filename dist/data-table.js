...
var H = (e, t) => {
...
}, ae = ["onClick"], Y = ["onDragstart", "onDragover"], oe = {
	class: "text-xs w-12 shrink-0",
	style: { color: "var(--st-text-tertiary)" }
}, se = ["onUpdate:modelValue"], ce = ["value"], le = ["onClick", "title"], ue = {
	class: "w-3 h-3",
	viewBox: "0 0 16 16",
	fill: "currentColor"
}, de = {
	...
	setup(t, { emit: n }) {
		...
		return (n, r) => (y(), o("div", {
			...
			h.value.length === 0 ? (y(), o("div", ee, [...r[3] ||= [s("p", { class: "mb-1" }, "No sorts applied to this view", -1), s("p", { class: "text-xs" }, "Add a column below to sort the view", -1)]])) : a("", !0),
			...
			p.value ? (y(), o(e, { key: 2 }, [
				...
				(y(!0), o(e, null, S(A.value, (n, i) => (y(), o("div", {
					...
					s("button", {
						...
						onClick: (e) => b(j("sub", i)),
						title: n.desc ? "Descending — click to toggle" : "Ascending — click to toggle"
					}, [(y(), o("svg", ue, [n.desc ? (y(), o("path", fe)) : (y(), o("path", de))])), l(" " + C(n.desc ? "DESC" : "ASC"), 1)], 12, le),
					s("button", {
						class: "shrink-0 w-5 h-5 flex items-center justify-center rounded transition-colors",
						style: { color: "var(--st-text-tertiary)" },
						title: "Remove sort rule",
	...
	setup(n, { emit: c }) {
		...
		function re(e) {
			v.value === "columns" ? ie(e) : v.value === "operators" ? ae(e) : e.key !== "Escape" && K(), e.key === "Escape" && (oe(), D.value?.blur());
		}
		function ie(e) {
			let t = B.value;
			if (t.length !== 0) {
				if (e.key === "ArrowDown") e.preventDefault(), E.value = Math.min(E.value + 1, t.length - 1), Y("column-picker");
				else if (e.key === "ArrowUp") e.preventDefault(), E.value = Math.max(E.value - 1, 0), Y("column-picker");
		...
		function ae(e) {
			let t = R.value;
			t.length !== 0 && (e.key === "ArrowDown" ? (e.preventDefault(), E.value = Math.min(E.value + 1, t.length - 1), Y("operator-picker")) : e.key === "ArrowUp" ? (e.preventDefault(), E.value = Math.max(E.value - 1, 0), Y("operator-picker")) : (e.key === "Enter" || e.key === "Tab") && (e.preventDefault(), t[E.value] && q(t[E.value].value)));
		}
		function Y(e) {
			m(() => {
		...
		return k(w, () => {
			...
			s("div", {
				...
				}, [s("span", Pe, C(e.id), 1), T(f) ? (y(), o("span", Q, C(e.type), 1)) : a("", !0)], 44, Ne))), 128)), z.value.length === 0 ? (y(), o("div", Fe, " No columns found ")) : a("", !0)], 4)) : a("", !0)])),
				...
				}, [(y(!0), o(e, null, S(L.value, (t, n) => (y(), o(e, { key: n }, [t.type === "header" ? (y(), o("div", Ie, C(t.label), 1)) : (y(), o("div", {
					key: 1,
					class: "flex items-center justify-between px-3 py-1.5 cursor-pointer text-[13px]",
...
}, lt = ["onClick"], ut = ["innerHTML"], dt = /* @__PURE__ */ H({
	__name: "TableToolbar",
	props: {
		table: {
			type: Object,
...
var pt = {
...
}, gt = ["onClick"], _t = ["innerHTML"], vt = ["onClick"], yt = /* @__PURE__ */ H({
	...
	setup(t, { emit: n }) {
		...
		return (n, r) => (y(), o("div", pt, [
			s("span", mt, C(t.selectedCount) + " row" + C(t.selectedCount > 1 ? "s" : "") + " selected", 1),
			...
			s("div", {
				...
				viewBox: "0 0 16 16",
				fill: "currentColor"
			}, [s("path", { d: "M4.427 6.427l3.396 3.396a.25.25 0 00.354 0l3.396-3.396A.25.25 0 0011.396 6H4.604a.25.25 0 00-.177.427z" })], -1)]]), m.value ? (y(), o("div", ht, [
				s("button", {
					class: "w-full text-left px-3 py-1.5 hover-menu-item",
					style: { color: "var(--st-text)" },
					onClick: r[2] ||= (e) => v("csv")
				...
				t.contextMenuActions.length > 0 ? (y(), o(e, { key: 0 }, [r[13] ||= s("div", {
					...
					type: "button",
					class: "w-full text-left px-3 py-1.5 hover-menu-item flex items-center gap-2",
					style: g({ color: T(ft)(e) ? "var(--st-danger)" : "var(--st-text)" }),
					onClick: (t) => E(e)
				}, [e.icon ? (y(), o("span", {
					key: 0,
					class: "shrink-0 w-3.5 h-3.5 inline-flex items-center justify-center [&_svg]:max-w-full [&_svg]:max-h-full",
					innerHTML: e.icon
				}, null, 8, _t)) : a("", !0), s("span", null, C(e.label), 1)], 12, gt))), 128))], 64)) : a("", !0),
...
}, [["__scopeId", "data-v-d800fe17"]]), bt = { class: "flex items-center gap-1.5 px-2 py-1.5 cursor-default overflow-hidden" }, xt = {
	...
	setup(e) {
		...
		return (n, d) => (y(), o("th", {
			...
			s("div", bt, [
				s("span", xt, [e.header.isPlaceholder ? a("", !0) : (y(), i(T(P), {
					key: 0,
					render: e.header.column.columnDef.header,
					props: e.header.getContext()
				}, null, 8, ["render", "props"]))]),
				T(r) ? (y(), o("span", St, C(T(b).type), 1)) : a("", !0),
				e.header.column.getIsSorted() ? (y(), o("span", Ct, C(e.header.column.getIsSorted() === "asc" ? "↑" : "↓"), 1)) : a("", !0),
				T(b).isFrozen ? (y(), o("span", wt, "❄")) : a("", !0),
				s("button", {
					ref_key: "triggerRef",
					ref: v,
...
}, [["__scopeId", "data-v-032be2da"]]), Et = ["title"], Dt = {
	class: "text-xs",
	style: { color: "var(--st-text-secondary)" }
}, Ot = {
	key: 1,
...
}, Lt = ["title"], Rt = ["innerHTML"], zt = ["title", "onClick"], Bt = ["innerHTML"], Vt = {
	key: 1,
	class: "text-[11px]"
}, Ht = {
	__name: "TableCell",
	...
	setup(t, { emit: n }) {
		...
		}), ne = r(() => ee.value && !U.value.badge), J = r(() => {
			let e = U.value;
		...
		function ie() {
			!u.value?.update || ne.value || U.value.progressBar || K.value.length > 0 || (R.value = !0, L("editing-change", !0), z.value = c.cell.getValue() ?? "", m(() => {
				B.value && (B.value.focus(), B.value.select(), ae());
			}));
		}
		function ae() {
		...
		function se(e) {
			e.key === "Enter" && !e.shiftKey ? (e.preventDefault(), Y()) : e.key === "Escape" && oe();
		}
		function ce() {
		...
		return (n, r) => (y(), o("div", {
		...
		}, [s("span", { class: h(["absolute top-0.5 w-3 h-3 rounded-full bg-white transition-transform", t.cell.getValue() ? "left-3.5" : "left-0.5"]) }, null, 2)], 4), s("span", Dt, C(t.cell.getValue() ? "true" : "false"), 1)])) : (y(), o("span", Ot, [t.cell.getValue() === null || t.cell.getValue() === void 0 ? (y(), o("span", kt, "NULL")) : (y(), o(e, { key: 1 }, [l(C(t.cell.getValue() ? "true" : "false"), 1)], 64))]))], 64)) : R.value ? (y(), o(e, { key: 1 }, [M(s("textarea", {
			ref_key: "textareaRef",
			ref: B,
			...
			s("div", Pt, [t.cell.getValue() === null || t.cell.getValue() === void 0 ? (y(), o("span", Ft, "NULL")) : q.value ? (y(), o("span", {
				key: 1,
				class: "inline-flex items-center px-1.5 py-0.5 rounded text-[11px] font-medium leading-tight",
				style: g(q.value.style)
			}, C(q.value.text), 5)) : G.value === "wrap" ? (y(), o("span", It, C(t.cell.getValue()), 1)) : (y(), o("span", {
				key: 3,
				class: "truncate block",
				title: String(t.cell.getValue())
			}, C(t.cell.getValue()), 9, Lt))]),
			J.value ? (y(), o("span", {
				key: 0,
				class: "w-3.5 h-3.5 shrink-0 flex items-center justify-center",
			...
			K.value.length > 0 ? (y(), o("div", {
				...
				innerHTML: e.icon
			}, null, 8, Bt)) : (y(), o("span", Vt, C(e.label), 1))], 8, zt))), 128))], 2)) : a("", !0)
		], 4)) : (y(), o("div", jt, [s("div", Mt, [s("div", {
			class: "h-full rounded-full transition-all duration-300",
			style: g({
				width: `${W.value}%`,
				backgroundColor: "var(--st-accent)"
			})
		}, null, 4)]), s("span", Nt, C(Math.round(W.value)) + "% ", 1)]))], 44, Et));
	}
}, Ut = ["data-index"], Wt = {
	class: "group/row",
	style: {
...
}, Gt = { class: "flex h-full gap-1 pr-1.5 pl-1 items-center justify-end pl-0.5" }, Kt = { class: "flex min-w-0 flex-1 items-center justify-end gap-0.5" }, qt = {
	class: "text-xs text-right whitespace-nowrap",
	style: { color: "var(--st-text-tertiary)" }
}, Jt = ["checked"], Yt = /* @__PURE__ */ H({
	...
	setup(t) {
		...
		return (n, r) => (y(), o("div", {
			...
			s("div", {
			...
			}, [s("div", Gt, [s("div", Kt, [z() ? (y(), o("button", {
				key: 0,
				...
				stroke: "currentColor",
				"stroke-width": "2"
			}, [s("path", { d: "M6 2h8v8M14 2L6 10" })], -1)]])) : a("", !0), s("span", qt, C(t.orderNumber), 1)])])], 4),
			s("div", {
			...
			(y(!0), o(e, null, S(t.row.getVisibleCells(), (e) => (y(), i(Ht, {
				key: e.id,
				cell: e,
...
}, [["__scopeId", "data-v-9f93e669"]]), Xt = 36, Zt = 56, Qt = 40, $t = 300, en = {
	...
	setup(t, { emit: n }) {
		let a = t, s = n, c = d("cellOverflow", "truncate"), l = d("getSubTable", null), u = d("expanded"), f = typeof window < "u" && "onscrollend" in window, p = r(() => T(u) ?? {}), m = V(r(() => {
			...
			return {
				...
				estimateSize: (i) => {
					...
					if (!a) return Xt;
					let o = n ? Zt : Xt;
					return r[a.id] ? t[a.id] ? Math.max(o, $t) : Math.max(o, Qt) : o;
				},
				overscan: 8,
		...
		return (n, r) => (y(), o("div", { style: g({
			...
			height: _.value + "px",
			width: t.totalTableWidth + "px"
		}) }, [(y(!0), o(e, null, S(h.value, (e) => (y(), i(Yt, {
			key: e.key,
			ref_for: !0,
			ref: (t) => v(t, e),
			row: t.rows[e.index],
	...
	setup(t, { emit: n }) {
		...
		}, [(y(!0), o(e, null, S(t.rows, (e, n) => (y(), i(Yt, {
			key: e.id,
			row: e,
			"row-index": n,
...
}, nn = ["checked", "indeterminate"], rn = {
	key: 0,
	class: "absolute inset-0 flex items-center justify-center pointer-events-none",
	style: { top: "33px" }
}, an = { class: "flex flex-col items-center gap-4 text-center px-6 pointer-events-auto" }, on = {
	...
	style: { color: "var(--st-accent)" }
}, cn = { class: "flex flex-col gap-1" }, ln = {
	...
	setup(n, { expose: c, emit: u }) {
		...
		}), _ = d("showRowBorders", !0), v = d("showColumnBorders", !0), b = d("emptyTitle", "No rows found"), D = d("emptyMessage", "Get started by inserting a new row."), O = d("openInsertPanel", null), k = d("defaultInsertLabel", null), A = d("insertRow", () => {}), j = x(!1), M = d("nestingDepth", 0), P = u, F = x(null), I = x(null), L = d("tableSourceRows", null), R = r(() => (L != null && w(L), f.table.getHeaderGroups())), z = r(() => 84 + f.table.getVisibleLeafColumns().reduce((e, t) => e + t.getSize(), 0)), B = r(() => (L != null && w(L), f.table.getRowModel().rows)), V = r(() => f.table.getState().pagination), H = d("isRowDisplayedSelected", null);
		function U(e) {
			let t = T(H);
			return typeof t == "function" ? t(e) : e.getIsSelected();
		}
		let ee = r(() => B.value.length ? B.value.every((e) => U(e)) : !1), W = r(() => {
			if (!B.value.length) return !1;
			let e = B.value.some((e) => U(e)), t = B.value.every((e) => U(e));
			return e && !t;
		});
		function G(e, t) {
			F.value = `${e}:${t}`;
		...
		function q() {
			f.table.toggleAllPageRowsSelected(!ee.value);
		}
		let ne = x(null);
		function J(e, t, n) {
			if (t?.shiftKey && ne.value !== null) {
				let e = Math.min(ne.value, n), t = Math.max(ne.value, n), r = B.value;
				for (let n = e; n <= t; n++) r[n].toggleSelected(!0);
			} else e.toggleSelected(!U(e));
			ne.value = n;
		}
		let re = r(() => {
			let e = v ? "inset -1px 0 0 var(--st-border)" : "", t = "2px 0 4px var(--st-shadow-sticky)";
			return e ? `${e}, ${t}` : t;
		}), ie = r(() => B.value.length > mn), ae = E("scroller");
		function Y(e, t) {
			I.value = e ? t : null;
		}
		function oe() {
		...
		function se() {
			return oe()?.clientWidth ?? 0;
		}
		return c({
			getScrollViewportInnerWidth: se,
			getViewportResizeObserveTarget: oe
			...
			(y(!0), o(e, null, S(t.headers, (e) => (y(), i(Tt, {
				key: e.id,
				header: e,
				table: n.table
			}, null, 8, ["header", "table"]))), 128))
		]))), 128))])], 4)], 4), B.value.length > 0 && ie.value ? (y(), i(en, {
			key: 0,
			rows: B.value,
			"scroll-element-ref": ae.value,
			"total-table-width": z.value,
			"selected-cell": F.value,
			"editing-row-id": I.value,
			"pagination-state": V.value,
			onToggleRowSelect: J,
			...
			"editing-row-id",
			"pagination-state"
		])) : a("", !0)], 2), B.value.length === 0 ? (y(), o("div", rn, [s("div", an, [
			s("div", on, [(y(), o("svg", sn, [...c[12] ||= [s("rect", {
				x: "3",
				y: "3",
				width: "18",
				height: "18",
			...
			s("div", cn, [s("p", ln, C(T(b)), 1), s("p", un, C(T(D)), 1)]),
			m.value.insert ? (y(), o("div", dn, [
				T(k) ? (y(), o("div", fn, [s("button", {
...
}, _n = ["disabled"], vn = { class: "flex items-center gap-1.5" }, yn = ["value", "max"], bn = {
	key: 1,
	class: "tabular-nums",
	style: { color: "var(--st-text)" }
}, xn = ["disabled"], Sn = { class: "flex items-center gap-1.5" }, Cn = ["value"], wn = {
	...
	stroke: "currentColor",
	"stroke-width": "2"
}, On = { style: { color: "var(--st-text-tertiary)" } }, kn = {
	class: "text-[13px] mb-4",
	style: { color: "var(--st-text-secondary)" }
}, An = { class: "flex items-center justify-end gap-2" }, jn = {
	...
	setup(n, { emit: c }) {
		...
		return (r, c) => (y(), o("div", gn, [
			s("button", {
				...
				viewBox: "0 0 16 16",
				fill: "currentColor"
			}, [s("path", { d: "M9.78 12.78a.75.75 0 01-1.06 0L4.47 8.53a.75.75 0 010-1.06l4.25-4.25a.75.75 0 011.06 1.06L6.06 8l3.72 3.72a.75.75 0 010 1.06z" })], -1)]], 8, _n),
			s("div", vn, [
				...
				n.hasRandomAccess ? (y(), o("input", {
					...
					onChange: k
				}, null, 40, yn)) : (y(), o("span", bn, C(h.value + 1), 1)),
			...
			s("button", {
				...
				viewBox: "0 0 16 16",
				fill: "currentColor"
			}, [s("path", { d: "M6.22 3.22a.75.75 0 011.06 0l4.25 4.25a.75.75 0 010 1.06l-4.25 4.25a.75.75 0 01-1.06-1.06L9.94 8 6.22 4.28a.75.75 0 010-1.06z" })], -1)]], 8, xn),
			c[14] ||= s("div", {
				class: "w-px h-4 mx-1",
				style: { backgroundColor: "var(--st-border)" }
			}, null, -1),
			s("div", Sn, [c[10] ||= s("span", null, "Rows per page:", -1), s("select", {
				value: _.value,
			...
			n.stagedEdits && n.pendingEditCount > 0 ? (y(), o(e, { key: 0 }, [
				s("span", wn, C(n.pendingEditCount) + " pending change" + C(n.pendingEditCount === 1 ? "" : "s"), 1),
				s("button", {
				...
				}, [n.committing ? (y(), o("svg", Dn, [...c[11] ||= [s("path", {
					d: "M8 1.5a6.5 6.5 0 1 1-6.5 6.5",
					"stroke-linecap": "round"
				}, null, -1)]])) : a("", !0), l(" " + C(n.committing ? "Committing…" : "Commit"), 1)], 8, En),
				c[12] ||= s("div", {
					class: "w-px h-4 mx-1",
					style: { backgroundColor: "var(--st-border)" }
				}, null, -1)
			], 64)) : a("", !0),
			s("span", On, C(D.value.toLocaleString()) + " " + C(D.value === 1 ? n.countLabelSingular : n.countLabelPlural), 1),
			(y(), i(t, { to: "body" }, [A.value ? (y(), o("div", {
				...
				s("p", kn, " This will discard " + C(n.pendingEditCount) + " pending change" + C(n.pendingEditCount === 1 ? "" : "s") + ". This action cannot be undone. ", 1),
				s("div", An, [s("button", {
...
}, Nn = { class: "flex items-center gap-2" }, Pn = {
	class: "text-sm",
	style: { color: "var(--st-text)" }
}, Fn = {
...
}, In = { class: "flex-1 overflow-auto px-5 py-4" }, Ln = {
	key: 0,
	class: "mb-6"
}, Rn = { class: "flex items-start gap-4" }, zn = { class: "w-40 shrink-0 pt-2" }, Bn = {
	class: "text-[13px] font-medium",
	style: { color: "var(--st-text)" }
}, Vn = {
	class: "text-xs",
	style: { color: "var(--st-text-tertiary)" }
}, Hn = { class: "flex-1" }, Un = ["disabled", "onClick"], Wn = {
	class: "text-xs",
	style: { color: "var(--st-text-secondary)" }
}, Gn = ["value"], Kn = ["onUpdate:modelValue", "placeholder"], qn = { key: 1 }, Jn = { class: "flex items-start gap-4" }, Yn = { class: "w-40 shrink-0 pt-2" }, Xn = {
	class: "text-[13px] font-medium",
	style: { color: "var(--st-text)" }
}, Zn = {
	class: "text-xs",
	style: { color: "var(--st-text-tertiary)" }
}, Qn = { class: "flex-1" }, $n = ["disabled", "onClick"], er = {
	class: "text-xs",
	style: { color: "var(--st-text-secondary)" }
}, tr = ["value"], nr = ["onUpdate:modelValue", "placeholder"], rr = {
	...
	setup(t, { emit: n }) {
		...
		return _(() => {
			...
			s("div", Mn, [s("div", Nn, [s("span", Pn, C(t.mode === "insert" ? "Insert row into" : "Update row from"), 1), s("code", Fn, C(t.tableName), 1)]), s("button", {
			...
			s("div", In, [m.value.length > 0 ? (y(), o("div", Ln, [(y(!0), o(e, null, S(m.value, (n) => (y(), o("div", {
				key: n.id,
				class: "mb-4"
			}, [s("div", Rn, [s("div", zn, [s("div", Bn, C(n.id), 1), s("div", Vn, C(n.meta.type), 1)]), s("div", Hn, [n.meta.type === "boolean" ? (y(), o("button", {
				key: 0,
			...
			}, [s("span", { class: h(["absolute top-[2px] w-[14px] h-[14px] rounded-full bg-white transition-transform", w.value[n.id] ? "left-[17px]" : "left-[2px]"]) }, null, 2)], 4), s("span", Wn, C(w.value[n.id] ? "true" : "false"), 1)], 10, Un)) : (y(), o(e, { key: 1 }, [n.meta.isPrimaryKey && t.mode === "update" || n.meta.readOnly && t.mode === "insert" ? (y(), o("input", {
				key: 0,
				value: w.value[n.id],
			...
			}, null, 8, Kn)), [[O, w.value[n.id]]])], 64))])])]))), 128))])) : a("", !0), b.value.length > 0 ? (y(), o("div", qn, [r[3] ||= s("div", { class: "mb-3" }, [s("h3", {
				...
				key: n.id,
				class: "mb-4"
			}, [s("div", Jn, [s("div", Yn, [s("div", Xn, C(n.id), 1), s("div", Zn, C(n.meta.type), 1)]), s("div", Qn, [n.meta.type === "boolean" ? (y(), o("button", {
				key: 0,
				class: h(["flex items-center gap-2", { "opacity-50 cursor-not-allowed": n.meta.readOnly && t.mode === "insert" }]),
				disabled: n.meta.readOnly && t.mode === "insert",
				onClick: (e) => !(n.meta.readOnly && t.mode === "insert") && (w.value[n.id] = !w.value[n.id])
				...
				class: "inline-block w-8 h-[18px] rounded-full relative transition-colors",
				style: g({ backgroundColor: w.value[n.id] ? "var(--st-accent)" : "var(--st-toggle-off)" })
			}, [s("span", { class: h(["absolute top-[2px] w-[14px] h-[14px] rounded-full bg-white transition-transform", w.value[n.id] ? "left-[17px]" : "left-[2px]"]) }, null, 2)], 4), s("span", er, C(w.value[n.id] ? "true" : "false"), 1)], 10, $n)) : (y(), o(e, { key: 1 }, [n.meta.readOnly && t.mode === "insert" ? (y(), o("input", {
				key: 0,
				value: w.value[n.id],
				class: "w-full rounded px-3 py-2 text-[13px] outline-none cursor-not-allowed",
				style: {
			...
			}, null, 8, nr)), [[O, w.value[n.id]]])], 64))])])]))), 128))])) : a("", !0)]),
			s("div", rr, [s("button", {
	...
	setup(n, { emit: c }) {
		...
		return (r, c) => (y(), i(t, { to: "body" }, [s("div", {
			...
			s("button", {
				...
				style: { color: "var(--st-text)" },
				onClick: P
			}, [(y(), o("svg", cr, [...c[4] ||= [s("path", { d: "M.75 3a.75.75 0 000 1.5h14.5a.75.75 0 000-1.5H.75zM3 7.75A.75.75 0 013.75 7h8.5a.75.75 0 010 1.5h-8.5A.75.75 0 013 7.75zm3 4a.75.75 0 01.75-.75h2.5a.75.75 0 010 1.5h-2.5a.75.75 0 01-.75-.75z" }, null, -1)]])), c[5] ||= l(" Filter by value ", -1)]),
			...
			n.customActions.length > 0 ? (y(), o(e, { key: 1 }, [c[9] ||= s("div", {
				...
				class: "shrink-0 w-3.5 h-3.5 inline-flex items-center justify-center [&_svg]:max-w-full [&_svg]:max-h-full",
				innerHTML: e.icon
			}, null, 8, ur)) : a("", !0), s("span", null, C(e.label), 1)], 12, lr))), 128))], 64)) : a("", !0),
			T(u).update || T(u).delete ? (y(), o(e, { key: 2 }, [
				...
				T(u).update ? (y(), o("button", {
					...
					style: { color: "var(--st-text)" },
					onClick: F
				}, [(y(), o("svg", dr, [...c[10] ||= [s("path", { d: "M11.013 1.427a1.75 1.75 0 012.474 0l1.086 1.086a1.75 1.75 0 010 2.474l-8.61 8.61c-.21.21-.47.364-.756.445l-3.251.93a.75.75 0 01-.927-.928l.929-3.25a1.75 1.75 0 01.445-.758l8.61-8.61z" }, null, -1)]])), c[11] ||= l(" Edit row ", -1)])) : a("", !0),
...
}, [["__scopeId", "data-v-6787adf2"]]), pr = { class: "px-5 pt-5 pb-4" }, mr = { style: { color: "var(--st-text-secondary)" } }, hr = {
	class: "px-5 py-3 flex items-center justify-end gap-2",
	style: { borderTop: "1px solid var(--st-border-secondary)" }
}, gr = {
	...
	setup(e, { emit: n }) {
		...
		return (n, c) => (y(), i(t, { to: "body" }, [e.modelValue ? (y(), o("div", {
			...
			style: { color: "var(--st-text)" }
		}, "Confirm deletion", -1), s("p", mr, " Are you sure you want to delete " + C(e.rowCount) + " row" + C(e.rowCount > 1 ? "s" : "") + "? This action cannot be undone. ", 1)]), s("div", hr, [s("button", {
			type: "button",
			class: "px-3 py-1.5 rounded text-[13px] transition-colors",
			style: {
				border: "1px solid var(--st-border-secondary)",
...
function vr(e, t) {
	let n = e.length, r = {};
	if (n === 0) return r;
	let i = Math.max(_r * n, Math.floor(t)), a = Math.floor(i / n), o = i - a * n;
...
var br = ["data-st-theme"], xr = {
...
}, Sr = { class: "flex-1" }, Cr = { class: "flex flex-1 min-h-0 min-w-0" }, wr = { class: "flex flex-col flex-1 min-w-0 min-h-0" }, Tr = "-apple-system, BlinkMacSystemFont, \"Segoe UI\", Roboto, \"Helvetica Neue\", Arial, sans-serif", Er = /* @__PURE__ */ H({
	__name: "DataTable",
	props: {
		columns: {
			type: Array,
	...
	setup(t, { expose: c, emit: l }) {
		...
		b(f, O);
		let A = r(() => ({ "--dt-font-family": O.value || Tr })), M = r(() => ({
			...E.value,
			...A.value,
			backgroundColor: "var(--st-bg)",
			color: "var(--st-text)"
		...
		let re = x([]), ie = x([]), ae = x({}), Y = x({}), oe = r(() => p.expandedRows ?? Y.value);
		function se(e) {
			p.expandedRows === null ? Y.value = {
				...Y.value,
				[e]: !Y.value[e]
		...
		let le = r(() => {
			...
			return "id";
		}), ue = r(() => p.totalCount !== null), de = r(() => p.totalFilteredCount == null ? p.totalCount : p.totalFilteredCount), fe = r(() => new Set((p.additionalSelectedRowIds || []).map((e) => String(e)))), pe = r(() => {
		...
		function Ne() {
			...
			let e = Me();
			ge.value = !0, H("commit-edits", e, (e) => {
				ge.value = !1, e && (X.value = /* @__PURE__ */ new Map());
			});
		}
		function Pe() {
			X.value = /* @__PURE__ */ new Map(), H("discard-edits");
		}
		let Q = z({
			data: Ce,
			get columns() {
			...
			onSortingChange: (e) => {
				W.value = typeof e == "function" ? e(W.value) : e, ue.value && H("sort-change", W.value);
			},
			onColumnFiltersChange: (e) => {
				G.value = typeof e == "function" ? e(G.value) : e, H("update:column-filters", G.value);
			},
			onRowSelectionChange: (e) => {
				let t = K.value, n = typeof e == "function" ? e(t) : e;
				if (ue.value && (p.additionalSelectedRowIds?.length ?? 0) > 0) {
			...
			onPaginationChange: (e) => {
				...
				te.value = t, ue.value && H("page-change", {
			...
			onColumnSizingInfoChange: (e) => {
				...
				ne.value = n, t.isResizingColumn && !n.isResizingColumn && H("column-resize", q.value);
			},
			...
			get pageCount() {
				if (ue.value) return Math.ceil(p.totalCount / te.value.pageSize);
			},
		...
		function Ie() {
			Q.resetRowSelection(), H("update:additionalSelectedRowIds", []);
		}
		...
		function We(e) {
			if (ze.value.mode === "insert") p.stagedEdits ? we(e) : H("insert-row", e);
			else if (p.stagedEdits) {
				let t = le.value, n = String(e[t] ?? e.id), r = be(n) ?? {}, i = {};
		...
		function Ge(e) {
			p.stagedEdits ? Ee(e) : H("delete-rows", e), Q.resetRowSelection(), H("update:additionalSelectedRowIds", []);
		}
		function Ke(e) {
		...
		function Ye(e, t, n) {
			p.stagedEdits ? Te(e, { [t]: n }) : H("update-row", {
				id: e,
				changes: { [t]: n }
			});
		}
		...
		return _(() => {
			...
			t.showToolbar ? (y(), o(e, { key: 0 }, [Re.value ? (y(), i(yt, {
				key: 0,
				"selected-count": T(Le),
				table: T(Q),
				editable: U.value,
				...
				"total-filtered-count": ue.value ? de.value : null,
				...
				onSelectionAction: c[0] ||= (e, t) => H("selection-action", e, t, me()),
			...
			t.error && !ee.value ? (y(), o("div", xr, [
				...
				s("span", Sr, C(t.error), 1),
				s("button", {
					class: "opacity-60 hover:opacity-100",
					onClick: c[11] ||= (e) => ee.value = !0
				}, [...c[18] ||= [s("svg", {
					class: "w-3.5 h-3.5",
					viewBox: "0 0 16 16",
					fill: "currentColor"
			...
			s("div", Cr, [s("div", wr, [u(hn, {
				...
				onContextMenu: Xe,
				onEditRow: He
			}, null, 8, ["table"]), t.showPagination ? (y(), i(jn, {
				key: 0,
				table: T(Q),
				...
				default: j(() => [(U.value.insert || U.value.update) && ze.value.open ? (y(), i(ir, {
					key: 0,
					mode: ze.value.mode,
...
}, [["__scopeId", "data-v-efdd6a82"]]);
//#endregion
export { Er as DataTable };
