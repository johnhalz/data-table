...
var H = (e, t) => {
...
}, K = ["onDragstart", "onDragover"], ee = {
	class: "text-xs w-12 shrink-0",
	style: { color: "var(--st-text-tertiary)" }
}, q = ["onUpdate:modelValue"], J = ["value"], te = ["onClick", "title"], Y = {
	class: "w-3 h-3",
	viewBox: "0 0 16 16",
	fill: "currentColor"
}, ne = {
...
}, ie = ["onClick"], X = ["onDragstart", "onDragover"], ae = {
	class: "text-xs w-12 shrink-0",
	style: { color: "var(--st-text-tertiary)" }
}, oe = ["onUpdate:modelValue"], se = ["value"], ce = ["onClick", "title"], Z = {
	class: "w-3 h-3",
	viewBox: "0 0 16 16",
	fill: "currentColor"
}, le = {
	...
	setup(t, { emit: n }) {
		...
		return (n, r) => (y(), o("div", {
			...
			(y(!0), o(e, null, S(O.value, (n, i) => (y(), o("div", {
				...
				s("span", ee, C(i === 0 ? "sort by" : "then by"), 1),
				M(s("select", {
					...
					key: t.id,
					value: t.id
				}, [l(C(t.id), 1), T(f) ? (y(), o(e, { key: 0 }, [l(" (" + C(t.type) + ")", 1)], 64)) : a("", !0)], 8, J))), 128))], 8, q), [[D, n.id]]),
				s("button", {
			...
			p.value ? (y(), o(e, { key: 2 }, [
				...
				(y(!0), o(e, null, S(A.value, (n, i) => (y(), o("div", {
					...
					s("span", ae, C(i === 0 ? "sort by" : "then by"), 1),
					M(s("select", {
						"onUpdate:modelValue": (e) => n.id = e,
						class: "sort-select flex-1 rounded py-1 text-[13px] outline-none min-w-0",
						style: {
						...
						key: t.id,
						value: t.id
					}, [l(C(t.id), 1), T(f) ? (y(), o(e, { key: 0 }, [l(" (" + C(t.type) + ")", 1)], 64)) : a("", !0)], 8, se))), 128))], 8, oe), [[D, n.id]]),
					s("button", {
						class: "shrink-0 w-[68px] flex items-center justify-center gap-1 px-2 py-1 rounded text-xs font-medium transition-colors",
						style: g(n.desc ? {
							color: "#3b82f6",
						...
						onClick: (e) => b(j("sub", i)),
						title: n.desc ? "Descending — click to toggle" : "Ascending — click to toggle"
					}, [(y(), o("svg", Z, [n.desc ? (y(), o("path", ue)) : (y(), o("path", le))])), l(" " + C(n.desc ? "DESC" : "ASC"), 1)], 12, ce),
					s("button", {
						class: "shrink-0 w-5 h-5 flex items-center justify-center rounded transition-colors",
						style: { color: "var(--st-text-tertiary)" },
						title: "Remove sort rule",
	...
	setup(n, { emit: c }) {
		...
		function ne(e) {
			v.value === "columns" ? re(e) : v.value === "operators" ? ie(e) : e.key !== "Escape" && ee(), e.key === "Escape" && (ae(), D.value?.blur());
		}
		function re(e) {
			let t = B.value;
			if (t.length !== 0) {
				if (e.key === "ArrowDown") e.preventDefault(), E.value = Math.min(E.value + 1, t.length - 1), X("column-picker");
				else if (e.key === "ArrowUp") e.preventDefault(), E.value = Math.max(E.value - 1, 0), X("column-picker");
		...
		function ie(e) {
			let t = R.value;
			t.length !== 0 && (e.key === "ArrowDown" ? (e.preventDefault(), E.value = Math.min(E.value + 1, t.length - 1), X("operator-picker")) : e.key === "ArrowUp" ? (e.preventDefault(), E.value = Math.max(E.value - 1, 0), X("operator-picker")) : (e.key === "Enter" || e.key === "Tab") && (e.preventDefault(), t[E.value] && J(t[E.value].value)));
		}
		function X(e) {
			m(() => {
...
var mt = {
...
}, _t = ["onClick"], vt = ["innerHTML"], yt = ["onClick"], bt = /* @__PURE__ */ H({
	...
	setup(e) {
		...
		return (n, d) => (y(), o("th", {
			...
			s("div", xt, [
				s("span", St, [e.header.isPlaceholder ? a("", !0) : (y(), i(T(P), {
					key: 0,
	...
	setup(t, { emit: n }) {
		...
		let Y = r(() => {
			...
			let i = String(r).trim();
			return i === "" ? null : i;
		}), X = r(() => c.cell.getValue() == null), ae = r(() => ie.value ? X.value ? !0 : !Y.value : !1), oe = r(() => ae.value ? "flex items-start gap-1 min-w-0" : "flex items-center gap-1 min-w-0");
		function se() {
			R.value || L("select");
		}
		function ce() {
			!u.value?.update || ne.value || U.value.progressBar || U.value.segmentedBar || J.value.length > 0 || (R.value = !0, L("editing-change", !0), z.value = c.cell.getValue() ?? "", m(() => {
				B.value && (B.value.focus(), B.value.select(), Z());
			}));
		}
		function Z() {
		...
		function de(e) {
			e.key === "Enter" && !e.shiftKey ? (e.preventDefault(), le()) : e.key === "Escape" && ue();
		}
		function fe() {
		...
		return (n, r) => (y(), o("div", {
		...
		])], 64)) : K.value ? (y(), o(e, { key: 2 }, [K.value.total === 0 ? (y(), o("div", Mt, [...r[2] ||= [s("span", {
			class: "italic text-[13px]",
			style: { color: "var(--st-text-placeholder)" }
		}, "—", -1)]])) : (y(), o("div", Nt, [s("div", Pt, [(y(!0), o(e, null, S(K.value.segments, (e) => (y(), o("div", {
			key: e.label,
			class: "h-full shrink-0",
			style: g({
				width: ee(e.count, K.value.total),
				backgroundColor: e.color
			})
		}, null, 4))), 128))]), s("div", Ft, [(y(!0), o(e, null, S(K.value.segments, (e) => (y(), o("span", {
			key: e.label,
			...
			s("div", zt, [t.cell.getValue() === null || t.cell.getValue() === void 0 ? (y(), o("span", Bt, "NULL")) : Y.value ? (y(), o("span", {
				key: 1,
			...
			}, C(Y.value.text), 5)) : q.value === "wrap" ? (y(), o("span", Vt, C(t.cell.getValue()), 1)) : (y(), o("span", {
				key: 3,
				class: "truncate block",
				title: String(t.cell.getValue())
			}, C(t.cell.getValue()), 9, Ht)), ae.value ? (y(), o("span", {
				key: 4,
				class: h(["block text-[11px] leading-snug", q.value === "wrap" ? "whitespace-pre-wrap break-words" : "truncate"]),
				style: { color: "var(--st-text-secondary)" },
				title: q.value === "wrap" ? void 0 : ie.value
			}, C(ie.value), 11, Ut)) : a("", !0)]),
			re.value ? (y(), o("span", {
				key: 0,
				class: "w-3.5 h-3.5 shrink-0 flex items-center justify-center",
			...
			}, [(y(!0), o(e, null, S(J.value, (e) => (y(), o("button", {
				key: e.label,
		...
		}, null, 4)]), s("span", Rt, C(Math.round(G.value)) + "% ", 1)]))], 44, Dt));
	}
}, Yt = ["data-index"], Xt = {
	class: "group/row",
	style: {
	...
	setup(t) {
		...
		return (n, r) => (y(), o("div", {
			...
			}, [s("div", Zt, [s("div", Qt, [z() ? (y(), o("button", {
				key: 0,
	...
	setup(n, { expose: c, emit: u }) {
		...
		}), b = d("showRowBorders", !0), D = d("showColumnBorders", !0), O = d("loading", !1), k = r(() => !!T(O)), A = d("emptyTitle", "No rows found"), j = d("emptyMessage", "Get started by inserting a new row."), M = d("openInsertPanel", null), P = d("defaultInsertLabel", null), F = d("insertRow", () => {}), I = x(!1), L = d("nestingDepth", 0), R = u, z = x(null), B = x(null), V = d("tableSourceRows", null), H = r(() => (V != null && w(V), m.table.getHeaderGroups())), U = r(() => 84 + m.table.getVisibleLeafColumns().reduce((e, t) => e + t.getSize(), 0)), W = r(() => (V != null && w(V), m.table.getRowModel().rows)), G = r(() => (V != null && w(V), m.table.getVisibleLeafColumns())), K = r(() => m.table.getState().pagination), ee = d("isRowDisplayedSelected", null);
		function q(e) {
			let t = T(ee);
			return typeof t == "function" ? t(e) : e.getIsSelected();
		}
		let J = r(() => W.value.length ? W.value.every((e) => q(e)) : !1), te = r(() => {
		...
		function re(e, t, n) {
			R("context-menu", e, t, n);
		}
		function ie() {
			m.table.toggleAllPageRowsSelected(!J.value);
		}
		let X = x(null);
		function ae(e, t, n) {
			if (t?.shiftKey && X.value !== null) {
				let e = Math.min(X.value, n), t = Math.max(X.value, n), r = W.value;
		...
		let oe = r(() => {
			...
			return e ? `${e}, ${t}` : t;
		}), se = r(() => W.value.length > bn), ce = E("scroller");
		function Z(e, t) {
			B.value = e ? t : null;
		}
		function le() {
		...
		function ue() {
			return le()?.clientWidth ?? 0;
		}
		return c({
			getScrollViewportInnerWidth: ue,
			getViewportResizeObserveTarget: le
		}), (r, c) => (y(), o("div", { class: h(T(L) === 0 ? "flex-1 min-h-0 relative" : "overflow-auto") }, [s("div", {
			ref: "scroller",
			class: h(T(L) === 0 ? "absolute inset-0 overflow-auto flex flex-col items-start min-h-0" : "flex flex-col items-start"),
		...
		}, [s("thead", null, [(y(!0), o(e, null, S(H.value, (t) => (y(), o("tr", { key: t.id }, [
			s("th", {
		...
		]))), 128))])], 4)], 4), W.value.length > 0 && se.value ? (y(), i(sn, {
			key: 0,
			rows: W.value,
			"scroll-element-ref": ce.value,
			"total-table-width": U.value,
			"selected-cell": z.value,
			"editing-row-id": B.value,
			"pagination-state": K.value,
			onToggleRowSelect: ae,
			onEditRow: c[0] ||= (e) => R("edit-row", e),
			onContextMenu: re,
			onSelectCell: Y,
			onUpdateCell: c[1] ||= (e, t, n) => R("update-cell", e, t, n),
			onEditingChange: Z
		}, null, 8, [
			"rows",
			"scroll-element-ref",
			...
			"pagination-state": K.value,
			onToggleRowSelect: ae,
			onEditRow: c[2] ||= (e) => R("edit-row", e),
			onContextMenu: re,
			onSelectCell: Y,
			onUpdateCell: c[3] ||= (e, t, n) => R("update-cell", e, t, n),
			onEditingChange: Z
		}, null, 8, [
			"rows",
			"total-table-width",
		...
		])), 64))])], 4)], 4)) : a("", !0)], 2), W.value.length === 0 && !k.value ? (y(), o("div", un, [s("div", dn, [
			s("div", fn, [(y(), o("svg", pn, [...c[12] ||= [s("rect", {
				x: "3",
				y: "3",
				width: "18",
				height: "18",
			...
			v.value.insert ? (y(), o("div", _n, [
				...
				I.value ? (y(), o("div", yn, [
					...
					s("button", {
						class: "w-full text-left px-3 py-1.5 hover-menu-item",
						style: { color: "var(--st-text)" },
						onClick: c[9] ||= (e) => I.value = !1
					}, " Import data from CSV ")
				])) : a("", !0),
				(y(), i(t, { to: "body" }, [I.value ? (y(), o("div", {
					key: 0,
					class: "fixed inset-0 z-40",
					onClick: c[10] ||= (e) => I.value = !1
				})) : a("", !0)]))
			])) : a("", !0)
		])])) : a("", !0)], 2));
	}
}, [["__scopeId", "data-v-a3d1cbe6"]]), Cn = {
	...
	setup(n, { emit: c }) {
		let u = d("editable", !0), f = d("themeVars", {}), p = d("getRowPendingState", () => null), h = d("getCellPendingState", () => null), b = n, w = c, E = r(() => b.row ? p(b.row.id) : null), D = r(() => b.row && b.cell ? h(b.row.id, b.cell.column.id) : null), O = r(() => E.value === "insert" ? "Discard new row" : E.value === "delete" ? "Restore row" : E.value === "update" ? "Undo row changes" : null), k = x(null), A = x(b.x), j = x(b.y), M = r(() => b.cell ? b.cell.getValue() : null), N = r(() => b.cell ? b.cell.column.id : null);
		function P(e) {
		...
		function F() {
			M.value !== null && M.value !== void 0 && P(String(M.value)), w("close");
		}
		function I() {
			b.row && P(JSON.stringify(b.row.original, null, 2)), w("close");
		}
		function L() {
			N.value && M.value !== null && M.value !== void 0 && w("filter-by-value", N.value, String(M.value)), w("close");
		}
		function R() {
			w("edit-row"), w("close");
		}
		...
		function H() {
			N.value && w("undo-cell", N.value), w("close");
		}
		function U(e) {
			w("row-action", e.key, b.row?.original), w("close");
		}
		B(k, () => {
			w("close");
		});
		...
		_(() => {
			document.addEventListener("keydown", W), m(() => {
				if (!k.value) return;
				let { width: e, height: t } = k.value.getBoundingClientRect(), n = window.innerWidth, r = window.innerHeight;
				A.value = Math.max(0, Math.min(b.x, n - e)), j.value = Math.max(0, Math.min(b.y, r - t));
			});
		}), v(() => {
...
}, [["__scopeId", "data-v-f460fc49"]]), br = { class: "px-5 pt-5 pb-4" }, xr = { style: { color: "var(--st-text-secondary)" } }, Sr = {
	class: "px-5 py-3 flex items-center justify-end gap-2",
	style: { borderTop: "1px solid var(--st-border-secondary)" }
}, Cr = {
...
var Dr = ["data-st-theme"], Or = {
...
}, kr = { class: "flex-1" }, Ar = { class: "flex flex-1 min-h-0 min-w-0" }, jr = { class: "flex flex-col flex-1 min-w-0 min-h-0" }, Mr = "-apple-system, BlinkMacSystemFont, \"Segoe UI\", Roboto, \"Helvetica Neue\", Arial, sans-serif", Nr = /* @__PURE__ */ H({
	__name: "DataTable",
	props: {
		columns: {
			type: Array,
	...
	setup(t, { expose: c, emit: l }) {
		...
		b(f, O);
		let A = r(() => ({ "--dt-font-family": O.value || Mr })), M = r(() => ({
			...E.value,
			...A.value,
			backgroundColor: "var(--st-bg)",
			color: "var(--st-text)"
		...
		let G = x(p.controlledSorting ?? []), K = x(p.controlledColumnFilters ?? p.columnFilters ?? []), ee = x({}), q = x({
			pageIndex: 0,
			pageSize: 100
		}), J = x({}), te = x({
			startOffset: null,
		...
		let ne = x([]), re = x([]), ie = x({}), X = x({}), ae = r(() => p.expandedRows ?? X.value);
		function oe(e) {
			p.expandedRows === null ? X.value = {
				...X.value,
				[e]: !X.value[e]
		...
		let ce = r(() => {
			...
			return "id";
		}), Z = r(() => p.totalCount !== null), le = r(() => p.totalFilteredCount == null ? p.totalCount : p.totalFilteredCount), ue = r(() => new Set((p.additionalSelectedRowIds || []).map((e) => String(e)))), de = r(() => {
			let e = new Set((p.additionalSelectedRowIds || []).map(String));
			for (let t of Object.keys(ee.value)) e.add(String(t));
			return e.size;
		});
		function fe() {
		...
		function pe(e) {
			let t = ce.value, n = String(e.original[t] ?? e.original.id);
		...
		let ye = r(() => Q.value.size > 0), be = r(() => Q.value.size), xe = r(() => {
			...
			let e = ce.value, t = [], n = p.rows.map((t) => {
		...
		function je() {
			...
			let e = Ae();
			me.value = !0, H("commit-edits", e, (e) => {
				me.value = !1, e && (Q.value = /* @__PURE__ */ new Map());
			});
		}
		function Me() {
			Q.value = /* @__PURE__ */ new Map(), H("discard-edits");
		}
		let Ne = z({
			data: xe,
			get columns() {
			...
			onSortingChange: (e) => {
				G.value = typeof e == "function" ? e(G.value) : e, Z.value && H("sort-change", G.value);
			},
			onColumnFiltersChange: (e) => {
				K.value = typeof e == "function" ? e(K.value) : e, H("update:column-filters", K.value);
			},
			onRowSelectionChange: (e) => {
				let t = ee.value, n = typeof e == "function" ? e(t) : e;
				if (Z.value && (p.additionalSelectedRowIds?.length ?? 0) > 0) {
			...
			onPaginationChange: (e) => {
				let t = typeof e == "function" ? e(q.value) : e;
				q.value = t, Z.value && H("page-change", {
			...
			get pageCount() {
				if (Z.value) return Math.ceil(p.totalCount / q.value.pageSize);
			},
		...
		function Fe() {
			Ne.resetRowSelection(), H("update:additionalSelectedRowIds", []);
		}
		...
		function Ue(e) {
			if (Re.value.mode === "insert") p.stagedEdits ? Se(e) : H("insert-row", e);
			else if (p.stagedEdits) {
				let t = ce.value, n = String(e[t] ?? e.id), r = ve(n) ?? {}, i = {};
		...
		function We(e) {
			p.stagedEdits ? we(e) : H("delete-rows", e), Ne.resetRowSelection(), H("update:additionalSelectedRowIds", []);
		}
		function Ge(e) {
		...
		function Je(e, t, n) {
			p.stagedEdits ? Ce(e, { [t]: n }) : H("update-row", {
				id: e,
				changes: { [t]: n }
			});
		}
		...
		return _(() => {
			...
			t.showToolbar ? (y(), o(e, { key: 0 }, [Le.value ? (y(), i(bt, {
				key: 0,
				"selected-count": T(Ie),
				table: T(Ne),
				editable: U.value,
				...
				"total-filtered-count": Z.value ? le.value : null,
				...
				onSelectionAction: c[0] ||= (e, t) => H("selection-action", e, t, fe()),
			...
			s("div", Ar, [s("div", jr, [u(Sn, {
				...
				default: j(() => [(U.value.insert || U.value.update) && Re.value.open ? (y(), i(dr, {
					key: 0,
					mode: Re.value.mode,
