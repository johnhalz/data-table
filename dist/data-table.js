...
var Tt = { class: "flex items-center gap-1.5 px-2 py-1.5 cursor-default overflow-hidden" }, Et = {
	...
	setup(t, { emit: n }) {
		...
		return (n, r) => (y(), o("div", {
		...
		])], 64)) : G.value ? (y(), o(e, { key: 2 }, [G.value.total === 0 ? (y(), o("div", It, [...r[2] ||= [s("span", {
			class: "italic text-[13px]",
			style: { color: "var(--st-text-placeholder)" }
		}, "—", -1)]])) : (y(), o("div", Lt, [s("div", Rt, [(y(!0), o(e, null, S(G.value.segments, (e) => (y(), o("div", {
			key: e.label,
		...
		}, null, 4))), 128))]), s("div", zt, [(y(!0), o(e, null, S(G.value.segments, (e) => (y(), o("span", {
			key: e.label,
			...
			s("div", Ut, [t.cell.getValue() === null || t.cell.getValue() === void 0 ? (y(), o("span", Wt, "NULL")) : J.value ? (y(), o("span", {
				key: 1,
			...
			}, C(J.value.text), 5)) : te.value === "wrap" ? (y(), o("span", Gt, C(t.cell.getValue()), 1)) : (y(), o("span", {
				key: 3,
			...
			}, [(y(!0), o(e, null, S(q.value, (e, n) => (y(), o("button", {
				key: n,
				type: "button",
		...
		}, null, 4)]), s("span", Ht, C(Math.round(W.value)) + "% ", 1)]))], 44, jt));
	}
}, $t = ["data-index"], en = {
	class: "group/row",
	style: {
	...
	setup(n, { expose: c, emit: u }) {
		...
		let Y = r(() => {
			...
			return e ? `${e}, ${t}` : t;
		}), de = r(() => K.value.length > wn), fe = E("scroller");
		function pe(e, t) {
			H.value = e ? t : null;
		}
		function me() {
		...
		]))), 128))])], 4)], 4), K.value.length > 0 && de.value ? (y(), i(dn, {
			key: 0,
			rows: K.value,
		...
		])), 64))])], 4)], 4)) : a("", !0)], 2), K.value.length === 0 && !k.value ? (y(), o("div", mn, [s("div", hn, [
...
var Fr = ["data-st-theme"], Ir = {
	...
	setup(t, { expose: c, emit: l }) {
		...
		return _(() => {
			...
			t.showToolbar ? (y(), o(e, { key: 0 }, [Re.value ? (y(), i(xt, {
				key: 0,
				"selected-count": T(Le),
				table: T(Q),
				editable: H.value,
			...
			s("div", Rr, [s("div", zr, [u(En, {
				...
				default: j(() => [(H.value.insert || H.value.update) && ze.value.open ? (y(), i(hr, {
					key: 0,
					mode: ze.value.mode,
			...
			$.value.show ? (y(), i(wr, {
				...
				"allow-row-edit": H.value.update,
				"allow-row-delete": H.value.delete,
				onClose: Ze,
