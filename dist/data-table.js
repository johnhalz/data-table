...
var V = (e, t) => {
	...
	class: "text-xs w-12 shrink-0",
	style: { color: "var(--st-text-tertiary)" }
}, oe = ["onUpdate:modelValue"], se = ["value"], ce = ["onClick", "title"], le = {
	class: "w-3 h-3",
	viewBox: "0 0 16 16",
	fill: "currentColor"
}, ue = {
			...
			p.value ? (y(), o(e, { key: 2 }, [
				...
				(y(!0), o(e, null, S(A.value, (n, i) => (y(), o("div", {
					...
					s("button", {
						...
						onClick: (e) => b(j("sub", i)),
						title: n.desc ? "Descending — click to toggle" : "Ascending — click to toggle"
					}, [(y(), o("svg", le, [n.desc ? (y(), o("path", de)) : (y(), o("path", ue))])), l(" " + C(n.desc ? "DESC" : "ASC"), 1)], 12, ce),
					s("button", {
						class: "shrink-0 w-5 h-5 flex items-center justify-center rounded transition-colors",
						style: { color: "var(--st-text-tertiary)" },
						title: "Remove sort rule",
	...
	setup(n, { emit: c }) {
		...
		return k(w, () => {
			...
			s("div", {
				...
				}, [s("span", Ne, C(e.id), 1), T(f) ? (y(), o("span", $, C(e.type), 1)) : a("", !0)], 44, Me))), 128)), R.value.length === 0 ? (y(), o("div", Pe, " No columns found ")) : a("", !0)], 4)) : a("", !0)])),
	...
	setup(t, { emit: n }) {
		...
		return (n, r) => (y(), o("div", Ze, [s("div", Qe, [
			...
			t.editable.insert ? (y(), o("div", {
				...
				s("button", {
					class: "w-full whitespace-nowrap text-left px-3 py-1.5 hover-menu-item",
					style: { color: "var(--st-text)" },
					onClick: r[15] ||= (e) => {
...
var pt = {
...
}, gt = ["onClick"], _t = ["innerHTML"], vt = ["onClick"], yt = /* @__PURE__ */ V({
...
}, [["__scopeId", "data-v-edc94983"]]), bt = { class: "flex items-center gap-1.5 px-2 py-1.5 cursor-default overflow-hidden" }, xt = {
	...
	setup(e) {
		...
		return (n, d) => (y(), o("th", {
			...
			s("div", bt, [
				s("span", xt, [e.header.isPlaceholder ? a("", !0) : (y(), i(T(N), {
					key: 0,
	...
	setup(t, { emit: n }) {
		...
		}), te = r(() => U.value && !H.value.badge), Y = r(() => {
			let e = H.value;
		...
		function re() {
			!u.value?.update || te.value || H.value.progressBar || K.value.length > 0 || (L.value = !0, I("editing-change", !0), R.value = c.cell.getValue() ?? "", m(() => {
				z.value && (z.value.focus(), z.value.select(), ie());
			}));
		}
		function ie() {
		...
		function oe(e) {
			e.key === "Enter" && !e.shiftKey ? (e.preventDefault(), X()) : e.key === "Escape" && ae();
		}
		function se() {
		...
		return (n, r) => (y(), o("div", {
			...
			onClick: ne,
			onDblclick: re
		}, [te.value ? (y(), o(e, { key: 0 }, [T(u).update ? (y(), o("button", {
			key: 0,
			...
			s("div", Pt, [t.cell.getValue() === null || t.cell.getValue() === void 0 ? (y(), o("span", Ft, "NULL")) : J.value ? (y(), o("span", {
				key: 1,
				class: "inline-flex items-center px-1.5 py-0.5 rounded text-[11px] font-medium leading-tight",
				style: g(J.value.style)
			}, C(J.value.text), 5)) : G.value === "wrap" ? (y(), o("span", It, C(t.cell.getValue()), 1)) : (y(), o("span", {
				key: 3,
	...
	setup(t) {
		...
		return (n, r) => (y(), o("div", {
			...
			}, [s("div", Gt, [s("div", Kt, [R() ? (y(), o("button", {
				key: 0,
	...
	setup(n, { expose: c, emit: u }) {
		...
		let oe = r(() => {
			...
			return e ? `${e}, ${t}` : t;
		}), se = r(() => U.value.length > mn), ce = E("scroller");
		function le(e, t) {
			z.value = e ? t : null;
		}
		function ue() {
		...
		function de() {
			return ue()?.clientWidth ?? 0;
		}
		return c({
			getScrollViewportInnerWidth: de,
			getViewportResizeObserveTarget: ue
		...
		]))), 128))])], 4)], 4), U.value.length > 0 && se.value ? (y(), i(en, {
			key: 0,
			rows: U.value,
			...
			class: "border-separate border-spacing-0 table-fixed w-full border-0 bg-transparent",
			style: g({ width: H.value + "px" })
		}, [s("tbody", null, [(y(), o(e, null, S(hn, (t) => s("tr", { key: t }, [
			s("td", {
		...
		])), 64))])], 4)], 4)) : a("", !0)], 2), U.value.length === 0 && !k.value ? (y(), o("div", rn, [s("div", an, [
			...
			s("div", cn, [s("p", ln, C(T(A)), 1), s("p", un, C(T(j)), 1)]),
			v.value.insert ? (y(), o("div", dn, [
				T(N) ? (y(), o("div", fn, [s("button", {
...
}, vn = ["disabled"], yn = { class: "flex items-center gap-1.5" }, bn = ["value", "max"], xn = {
	key: 1,
	class: "tabular-nums",
	style: { color: "var(--st-text)" }
}, Sn = ["disabled"], Cn = { class: "flex items-center gap-1.5" }, wn = ["value"], Tn = {
	...
	stroke: "currentColor",
	"stroke-width": "2"
}, kn = { style: { color: "var(--st-text-tertiary)" } }, An = {
	class: "text-[13px] mb-4",
	style: { color: "var(--st-text-secondary)" }
}, jn = { class: "flex items-center justify-end gap-2" }, Mn = {
	...
	setup(n, { emit: c }) {
		...
		return (r, c) => (y(), o("div", _n, [
			s("button", {
				...
				viewBox: "0 0 16 16",
				fill: "currentColor"
			}, [s("path", { d: "M9.78 12.78a.75.75 0 01-1.06 0L4.47 8.53a.75.75 0 010-1.06l4.25-4.25a.75.75 0 011.06 1.06L6.06 8l3.72 3.72a.75.75 0 010 1.06z" })], -1)]], 8, vn),
			s("div", yn, [
				...
				n.hasRandomAccess ? (y(), o("input", {
					...
					onChange: k
				}, null, 40, bn)) : (y(), o("span", xn, C(h.value + 1), 1)),
			...
			s("button", {
				...
				viewBox: "0 0 16 16",
				fill: "currentColor"
			}, [s("path", { d: "M6.22 3.22a.75.75 0 011.06 0l4.25 4.25a.75.75 0 010 1.06l-4.25 4.25a.75.75 0 01-1.06-1.06L9.94 8 6.22 4.28a.75.75 0 010-1.06z" })], -1)]], 8, Sn),
			c[14] ||= s("div", {
				class: "w-px h-4 mx-1",
				style: { backgroundColor: "var(--st-border)" }
			}, null, -1),
			s("div", Cn, [c[10] ||= s("span", null, "Rows per page:", -1), s("select", {
				value: _.value,
			...
			n.stagedEdits && n.pendingEditCount > 0 ? (y(), o(e, { key: 0 }, [
				s("span", Tn, C(n.pendingEditCount) + " pending change" + C(n.pendingEditCount === 1 ? "" : "s"), 1),
				s("button", {
				...
				}, [n.committing ? (y(), o("svg", On, [...c[11] ||= [s("path", {
					d: "M8 1.5a6.5 6.5 0 1 1-6.5 6.5",
					"stroke-linecap": "round"
				}, null, -1)]])) : a("", !0), l(" " + C(n.committing ? "Committing…" : "Commit"), 1)], 8, Dn),
				c[12] ||= s("div", {
					class: "w-px h-4 mx-1",
					style: { backgroundColor: "var(--st-border)" }
				}, null, -1)
			], 64)) : a("", !0),
			s("span", kn, C(D.value.toLocaleString()) + " " + C(D.value === 1 ? n.countLabelSingular : n.countLabelPlural), 1),
			(y(), i(t, { to: "body" }, [A.value ? (y(), o("div", {
				...
				s("p", An, " This will discard " + C(n.pendingEditCount) + " pending change" + C(n.pendingEditCount === 1 ? "" : "s") + ". This action cannot be undone. ", 1),
				s("div", jn, [s("button", {
...
}, Pn = { class: "flex items-center gap-2" }, Fn = {
	class: "text-sm",
	style: { color: "var(--st-text)" }
}, In = {
...
}, Ln = { class: "flex-1 overflow-auto px-5 py-4" }, Rn = {
	key: 0,
	class: "mb-6"
}, zn = { class: "flex items-start gap-4" }, Bn = { class: "w-40 shrink-0 pt-2" }, Vn = {
	class: "text-[13px] font-medium",
	style: { color: "var(--st-text)" }
}, Hn = {
	class: "text-xs",
	style: { color: "var(--st-text-tertiary)" }
}, Un = { class: "flex-1" }, Wn = ["disabled", "onClick"], Gn = {
	class: "text-xs",
	style: { color: "var(--st-text-secondary)" }
}, Kn = ["value"], qn = ["onUpdate:modelValue", "placeholder"], Jn = { key: 1 }, Yn = { class: "flex items-start gap-4" }, Xn = { class: "w-40 shrink-0 pt-2" }, Zn = {
	class: "text-[13px] font-medium",
	style: { color: "var(--st-text)" }
}, Qn = {
	class: "text-xs",
	...
	class: "text-xs",
	style: { color: "var(--st-text-secondary)" }
}, nr = ["value"], rr = ["onUpdate:modelValue", "placeholder"], ir = {
	...
	setup(t, { emit: n }) {
		...
		return _(() => {
			...
			s("div", Nn, [s("div", Pn, [s("span", Fn, C(t.mode === "insert" ? "Insert row into" : "Update row from"), 1), s("code", In, C(t.tableName), 1)]), s("button", {
			...
			s("div", Ln, [m.value.length > 0 ? (y(), o("div", Rn, [(y(!0), o(e, null, S(m.value, (n) => (y(), o("div", {
				key: n.id,
				class: "mb-4"
			}, [s("div", zn, [s("div", Bn, [s("div", Vn, C(n.id), 1), s("div", Hn, C(n.meta.type), 1)]), s("div", Un, [n.meta.type === "boolean" ? (y(), o("button", {
				key: 0,
			...
			}, [s("span", { class: h(["absolute top-[2px] w-[14px] h-[14px] rounded-full bg-white transition-transform", w.value[n.id] ? "left-[17px]" : "left-[2px]"]) }, null, 2)], 4), s("span", Gn, C(w.value[n.id] ? "true" : "false"), 1)], 10, Wn)) : (y(), o(e, { key: 1 }, [n.meta.isPrimaryKey && t.mode === "update" || n.meta.readOnly && t.mode === "insert" ? (y(), o("input", {
				key: 0,
				value: w.value[n.id],
			...
			}, null, 8, qn)), [[O, w.value[n.id]]])], 64))])])]))), 128))])) : a("", !0), b.value.length > 0 ? (y(), o("div", Jn, [r[3] ||= s("div", { class: "mb-3" }, [s("h3", {
				...
				class: "inline-block w-8 h-[18px] rounded-full relative transition-colors",
				style: g({ backgroundColor: w.value[n.id] ? "var(--st-accent)" : "var(--st-toggle-off)" })
			}, [s("span", { class: h(["absolute top-[2px] w-[14px] h-[14px] rounded-full bg-white transition-transform", w.value[n.id] ? "left-[17px]" : "left-[2px]"]) }, null, 2)], 4), s("span", tr, C(w.value[n.id] ? "true" : "false"), 1)], 10, er)) : (y(), o(e, { key: 1 }, [n.meta.readOnly && t.mode === "insert" ? (y(), o("input", {
				key: 0,
				value: w.value[n.id],
				class: "w-full rounded px-3 py-2 text-[13px] outline-none cursor-not-allowed",
				style: {
			...
			}, null, 8, rr)), [[O, w.value[n.id]]])], 64))])])]))), 128))])) : a("", !0)]),
			s("div", ir, [s("button", {
	...
	setup(n, { emit: c }) {
		...
		return (r, c) => (y(), i(t, { to: "body" }, [s("div", {
			...
			s("button", {
				...
				style: { color: "var(--st-text)" },
				onClick: N
			}, [(y(), o("svg", lr, [...c[4] ||= [s("path", { d: "M.75 3a.75.75 0 000 1.5h14.5a.75.75 0 000-1.5H.75zM3 7.75A.75.75 0 013.75 7h8.5a.75.75 0 010 1.5h-8.5A.75.75 0 013 7.75zm3 4a.75.75 0 01.75-.75h2.5a.75.75 0 010 1.5h-2.5a.75.75 0 01-.75-.75z" }, null, -1)]])), c[5] ||= l(" Filter by value ", -1)]),
			...
			n.customActions.length > 0 ? (y(), o(e, { key: 1 }, [c[9] ||= s("div", {
				...
				class: "shrink-0 w-3.5 h-3.5 inline-flex items-center justify-center [&_svg]:max-w-full [&_svg]:max-h-full",
				innerHTML: e.icon
			}, null, 8, dr)) : a("", !0), s("span", null, C(e.label), 1)], 12, ur))), 128))], 64)) : a("", !0),
			T(u).update || T(u).delete ? (y(), o(e, { key: 2 }, [
				...
				T(u).update ? (y(), o("button", {
					...
					style: { color: "var(--st-text)" },
					onClick: P
				}, [(y(), o("svg", fr, [...c[10] ||= [s("path", { d: "M11.013 1.427a1.75 1.75 0 012.474 0l1.086 1.086a1.75 1.75 0 010 2.474l-8.61 8.61c-.21.21-.47.364-.756.445l-3.251.93a.75.75 0 01-.927-.928l.929-3.25a1.75 1.75 0 01.445-.758l8.61-8.61z" }, null, -1)]])), c[11] ||= l(" Edit row ", -1)])) : a("", !0),
...
}, [["__scopeId", "data-v-6787adf2"]]), mr = { class: "px-5 pt-5 pb-4" }, hr = { style: { color: "var(--st-text-secondary)" } }, gr = {
	class: "px-5 py-3 flex items-center justify-end gap-2",
	style: { borderTop: "1px solid var(--st-border-secondary)" }
}, _r = {
...
var xr = ["data-st-theme"], Sr = {
	...
	setup(t, { expose: c, emit: l }) {
		...
		b(f, O);
		let A = r(() => ({ "--dt-font-family": O.value || Er })), ee = r(() => ({
			...E.value,
			...A.value,
			backgroundColor: "var(--st-bg)",
			color: "var(--st-text)"
		...
		let ce = r(() => {
			...
			return "id";
		}), le = r(() => p.totalCount !== null), ue = r(() => p.totalFilteredCount == null ? p.totalCount : p.totalFilteredCount), de = r(() => new Set((p.additionalSelectedRowIds || []).map((e) => String(e)))), fe = r(() => {
		...
		let $ = R({
			...
			onSortingChange: (e) => {
				W.value = typeof e == "function" ? e(W.value) : e, le.value && V("sort-change", W.value);
			},
			...
			onRowSelectionChange: (e) => {
				...
				if (le.value && (p.additionalSelectedRowIds?.length ?? 0) > 0) {
			...
			onPaginationChange: (e) => {
				...
				q.value = t, le.value && V("page-change", {
			...
			get pageCount() {
				if (le.value) return Math.ceil(p.totalCount / q.value.pageSize);
			},
		...
		function Fe() {
			$.resetRowSelection(), V("update:additionalSelectedRowIds", []);
		}
		...
		function Ue(e) {
			if (Re.value.mode === "insert") p.stagedEdits ? Ce(e) : V("insert-row", e);
			else if (p.stagedEdits) {
				let t = ce.value, n = String(e[t] ?? e.id), r = ye(n) ?? {}, i = {};
		...
		function We(e) {
			p.stagedEdits ? Te(e) : V("delete-rows", e), $.resetRowSelection(), V("update:additionalSelectedRowIds", []);
		}
		function Ge(e) {
		...
		function Je(e, t, n) {
			p.stagedEdits ? we(e, { [t]: n }) : V("update-row", {
				id: e,
				changes: { [t]: n }
			});
		}
		...
		return _(() => {
			...
			t.showToolbar ? (y(), o(e, { key: 0 }, [Le.value ? (y(), i(yt, {
				key: 0,
				"selected-count": T(Ie),
				table: T($),
				editable: H.value,
				...
				"total-filtered-count": le.value ? ue.value : null,
				...
				onSelectionAction: c[0] ||= (e, t) => V("selection-action", e, t, pe()),
			...
			s("div", wr, [s("div", Tr, [u(gn, {
				...
				onContextMenu: Xe,
				onEditRow: Ve
			}, null, 8, ["table"]), t.showPagination ? (y(), i(Mn, {
				key: 0,
				table: T($),
				...
				default: j(() => [(H.value.insert || H.value.update) && Re.value.open ? (y(), i(ar, {
					key: 0,
					mode: Re.value.mode,
